...
Note: to view with functioning dropdowns, you must switch to <strong>Canvas View</strong>.
...
### Example of a simple combination
...
### Example with navigation headings
