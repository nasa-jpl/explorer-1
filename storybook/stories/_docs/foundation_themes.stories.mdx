...
Apply a body class of `.ThemeInternal` to your build to reflect JPL's internal color scheme. Currently, this only overrides `BaseLink` colors.

The following story is wrapped in the class `ThemeInternal` for demonstration purposes.
      ...
      <div class="ThemeInternal">
        ...
        <div>
          <a
            ...
            target=""
            rel=""
            class="BaseLink group cursor-pointer -secondary text-subtitle text-theme-red can-hover:hover:text-theme-red-hover"
          >
            BaseLink
          </a>
        </div>
...
You can switch to view this theme on any Storybook story using the toolbar menu (the "picture" icon).
