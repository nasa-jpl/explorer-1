...
Browse the [Foundation section](?path=/docs/foundation-colors--page) of this Storybook to become familiar with how to use utility classes for:
...
<details className="pl-4 -mt-3 text-sm">
  <summary> <span className="font-medium border-b border-blue hover:border-gray-dark">Watch how customize a component</span></summary>
