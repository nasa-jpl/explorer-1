...
Then learn about our [Base components](?path=/docs/components-base-overview--page), specifically how to use the [grid and layout classes](?path=/docs/components-base-grid-and-layout--base-grid). Becoming familiar with the grid will enable you to create entire page layouts, such as to [this example layout](?path=/story/components-base-grid-and-layout--full-page-demo).
