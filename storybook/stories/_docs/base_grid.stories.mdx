...
<Meta
  title="Components/Base/Grid and Layout"
  parameters={{ viewMode: 'docs' }}
/>

# Grid and Layout

We use a 12-column grid paired with our [Responsive Design](?path=/docs/getting-started-responsive-design--responsive-design) strategy to create all of our page and component layouts.
