import{P as a,a as r}from"./ParallaxElement-DlZETLqS.js";import"./iframe-C-WUJfw1.js";import"./preload-helper-D6kgxu3v.js";const i={title:"Components/Utilities/ParallaxContainer",component:a,decorators:[()=>({template:'<div id="storyRoot" style="height:3000px"><story/></div>'})],parameters:{html:{root:"#storyRoot"},docs:{description:{component:"Use `ParallaxContainer` with a nested `ParallaxElement` to create a parallax scrolling effect."}}},excludeStories:/.*(Data)$/},l=e=>({props:Object.keys(e),components:{ParallaxContainer:a,ParallaxElement:r},template:`<ParallaxContainer :invert="invert" :overflow="overflow">
    ...
    <div class="border-black border p-16"><div class="text-h2">Static Content</div><p>Lorem ipsum</p></div>
  </ParallaxContainer>`}),t=l.bind({});t.storyName="ParallaxContainer";t.args={invert:!0,overflow:!0};const d=["BaseStory"];export{t as BaseStory,d as __namedExportsOrder,i as default};
