import{B as m}from"./BaseLink-BM1wc07I.js";import{B as g}from"./BaseImagePlaceholder-KhPDDuZV.js";import{a as x}from"./IconDownload-BH8PYKeu.js";const $=({url:r,title:n,headingLevel:t,label:e,secondaryLabel:l,image:a,customClass:s,compact:i})=>{t||(t="p"),s||(s="");let p=g({theme:"dark-theme",noLogo:!0,aspectRatio:i?"aspect-ratio-one-one":"aspect-ratio-eight-seven",src:a.src.url,srcset:a.srcset,alt:"",width:a.src.width,height:a.src.height,imageClass:"w-full h-full",objectFitClass:"object-cover"}),c=x({}),o="";(e||l)&&(o=`
