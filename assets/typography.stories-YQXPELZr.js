import{I as t}from"./IconLocation-CUyqMFQl.js";const s={title:"Foundation/Typography",tags:["!autodocs"]},o=()=>`<div class="Fonts md:grid-cols-2 grid gap-2 mt-4">
  <div>
  ...
  <code>mark</code>
</div>`,c={render:i.bind({})},e=t({customClass:"inline"}),n=()=>`<div>
  ...
  <code>h6, .text-h6</code>
</div>`,r={render:n.bind({})},p=()=>`<div style="background-image: url(http://source.unsplash.com/b-P6xrDMFSU); background-color: #000;" class="bg-cover bg-no-repeat bg-center">
...
</div>`,m={render:p.bind({})},h=["Fonts","TextColor","TextStyles","HeadingIcons","TextContrast"],g=Object.freeze(Object.defineProperty({__proto__:null,Fonts:a,HeadingIcons:r,TextColor:l,TextContrast:m,TextStyles:c,__namedExportsOrder:h,default:s},Symbol.toStringTag,{value:"Module"}));export{a as F,r as H,g as S,l as T,c as a,m as b};
