import{I as f}from"./IconLocation-CUyqMFQl.js";const T={title:"Foundation/Typography",tags:["!autodocs"]},k=()=>`<div class="Fonts md:grid-cols-2 grid gap-2 mt-4">
  <div>
  ...
  <code>mark</code>
</div>`,a={render:S.bind({})},e=f({customClass:"inline"}),z=()=>`<div>
  <p class="text-h1-alt mt-8">${e}Header H1 Alt</p>
  <code>.text-h1-alt</code>
  <p class="text-h1 mt-8">${e}Header H1</p>
  <code>h1, .text-h1</code>
  <p class="text-h2 mt-8">${e}Header H2</p>
  <code>h2, .text-h2</code>
  <p class="text-h3 mt-8">${e}Header H3</p>
  <code>h3, .text-h3</code>
  <p class="text-h4 mt-8">${e}Header H4</p>
  <code>h4, .text-h4</code>
  <p class="text-h5 mt-8">${e}Header H5</p>
  <code>h5, .text-h5</code>
  <p class="text-h6 mt-8">${e}Header H6</p>
  <code>h6, .text-h6</code>
</div>`,o={render:z.bind({})},C=()=>`<div style="background-image: url(http://source.unsplash.com/b-P6xrDMFSU); background-color: #000;" class="bg-cover bg-no-repeat bg-center">
...
</div>`,d={render:C.bind({})};var l,c,r;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: FontsTemplate.bind({})
}`,...(r=(c=t.parameters)==null?void 0:c.docs)==null?void 0:r.source}}};var i,n,p;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: TextColorTemplate.bind({})
}`,...(p=(n=s.parameters)==null?void 0:n.docs)==null?void 0:p.source}}};var m,x,h;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: TextStylesTemplate.bind({})
}`,...(h=(x=a.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};var g,b,v;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: HeadingIconsTemplate.bind({})
}`,...(v=(b=o.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var y,u,H;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: TextContrastTemplate.bind({})
}`,...(H=(u=d.parameters)==null?void 0:u.docs)==null?void 0:H.source}}};const M=["Fonts","TextColor","TextStyles","HeadingIcons","TextContrast"],F=Object.freeze(Object.defineProperty({__proto__:null,Fonts:t,HeadingIcons:o,TextColor:s,TextContrast:d,TextStyles:a,__namedExportsOrder:M,default:T},Symbol.toStringTag,{value:"Module"}));export{t as F,o as H,F as S,s as T,a,d as b};
