import{_ as s}from"./TextArea-B4HArPiZ.js";const a={title:"Components/Forms/TextArea",component:s,tags:["forms"]},e={args:{inputName:"message",required:!0,label:"Your Message",placeholder:"Enter your message here",rows:10}},r={name:"Hidden Label",args:{inputName:"message",label:"Your Message",showLabel:!1,required:!1,placeholder:"Your message here"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    inputName: 'message',
    required: true,
    label: 'Your Message',
