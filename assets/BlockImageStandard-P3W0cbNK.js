import{B as p}from"./BaseImagePlaceholder-KhPDDuZV.js";import{B as d}from"./BaseImageCaption-vks4WUeh.js";import{B as u}from"./BaseButton-DpIDzJwf.js";const b=({variant:t,fancyboxGallery:o,image:e,icon:r,label:c})=>{let a="data-fancybox";return o&&(a+=`="${o}"`),(e.credit||e.caption)&&(a+=' data-caption="',e.caption&&(a+=e.caption.replace(/<[^>]*>?/gm,"")),e.caption&&e.credit&&(a+=" "),e.credit&&(a+=`Credit: ${e.credit}`),a+='"'),a+=` data-src="${e.src.url}"`,u({variant:t,icon:r,label:c,fancybox:a,iconOnly:!0})},h=({image:t,fancyboxGallery:o})=>`
