import{_ as m}from"./TextArea-C86vEt2a.js";const u={title:"Components/Forms/TextArea",component:m,tags:["forms"]},e={args:{inputName:"message",required:!0,label:"Your Message",placeholder:"Enter your message here",rows:10}},r={name:"Hidden Label",args:{inputName:"message",label:"Your Message",showLabel:!1,required:!1,placeholder:"Your message here"}};var s,a,o;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    inputName: 'message',
    required: true,
    label: 'Your Message',
