import{_ as s,o as a,b as o,Y as d}from"./iframe-BaEhLE_2.js";import{I as i}from"./IconLocation-_3S00_xB.js";import{B as l}from"./BaseHeading-CcqVUTK5.js";const c={},n={class:"Fonts md:grid-cols-2 grid gap-2 mt-4"};function r(e,t){return a(),o("div",n,t[0]||(t[0]=[d('<div><h3 id="primary" class="inline-block align-top mr-4 font-primary"> Metropolis <br><code class="text-base">.font-primary</code></h3><ol class="list-none inline-block"><li><span class="leading-loose"><span class="capitalize font-primary font-light"> Metropolis light </span><code>.font-light</code></span></li><li><span class="leading-loose"><span class="capitalize font-primary font-normal"> Metropolis normal </span><code>.font-normal</code></span></li><li><span class="leading-loose"><span class="capitalize font-primary font-medium"> Metropolis medium </span><code>.font-medium</code></span></li><li><span class="leading-loose"><span class="capitalize font-primary font-semibold"> Metropolis semi bold </span><code>.font-semibold</code></span></li><li><span class="leading-loose"><span class="capitalize font-primary font-bold">Metropolis bold</span><code>.font-bold</code></span></li><li><span class="leading-loose"><span class="capitalize font-primary font-extrabold"> Metropolis extra bold </span><code>.font-extrabold</code></span></li></ol></div><div><h3 id="secondary" class="inline-block align-top mr-4 font-secondary"> Archivo Narrow <br><code class="text-base">.font-secondary</code></h3><ol class="list-none inline-block"><li></li><li></li><li></li><li><span class="leading-loose"><span class="capitalize font-secondary font-semibold"> Archivo Narrow semi bold </span><code>.font-semibold</code></span></li><li><span class="leading-loose"><span class="capitalize font-secondary font-bold"> Archivo Narrow bold </span><code>.font-bold</code></span></li><li></li></ol></div>',2)]))}const p=s(c,[["render",r]]),m={title:"Foundations/Typography",component:p,tags:["!autodocs"]},g={args:{}},h={args:{},render:()=>({template:`<div>
  ...
  <code>.math-text</code>
</div>`})},b={argTypes:{size:{type:{name:"string",required:!0},control:{type:"select"},options:["h1","h2","h3","h4","h5","h6"]}},args:{size:"h1"},render:e=>({components:{BaseHeading:l,IconLocation:i},setup(){return{args:e}},template:`<div>
      <BaseHeading v-bind="args"><IconLocation class="inline" /> Heading H1</BaseHeading>
    </div>`})},y={args:{},render:()=>({template:`<div style="background-image: url('https://fastly.picsum.photos/id/1015/1000/40.jpg?hmac=fpUcZPtNEqNVb9cio8CwkUIBZKywJSfhaxdieF0Uxgk');" class="bg-cover bg-no-repeat bg-center">
...
</div>`})},v=["Fonts","TextColors","TextStyles","HeadingIcons","TextContrast"],k=Object.freeze(Object.defineProperty({__proto__:null,Fonts:g,HeadingIcons:b,TextColors:h,TextContrast:y,TextStyles:x,__namedExportsOrder:v,default:m},Symbol.toStringTag,{value:"Module"}));export{g as F,b as H,k as S,h as T,x as a,y as b};
