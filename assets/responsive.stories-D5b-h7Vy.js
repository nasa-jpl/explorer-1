import{L as t}from"./LayoutHelper-dMEIgpby.js";const s={title:"Guides/Responsive Design",component:t,tags:["!autodocs"]},r={args:{},render:()=>({template:`<div class="bg-gray-light border">
  <code>body</code>
...
</div>`})};var d,e,a;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {},
  render: () => ({
...
}`,...(a=(e=r.parameters)==null?void 0:e.docs)==null?void 0:a.source}}};const o=["Demo"],c=Object.freeze(Object.defineProperty({__proto__:null,Demo:r,__namedExportsOrder:o,default:s},Symbol.toStringTag,{value:"Module"}));export{r as D,c as S};
