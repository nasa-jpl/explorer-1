import{B as l}from"./BaseIframe-CN0Xf0EZ.js";import{B as c}from"./BaseImageCaption-DGqx0YEt.js";import{B as p}from"./BaseImagePlaceholder-BjDXo6VY.js";const a=({title:e,url:m,height:n,caption:t})=>{t&&(t=`<div class="lg:px-0 p-4 pb-0">${c({caption:t,url:m})}</div>`);const d=l({title:e,url:m,height:n});return`
