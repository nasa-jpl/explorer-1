import{a as d,I as h}from"./IconDownload-BH8PYKeu.js";import{I as g}from"./IconArrows-f9_vo7fG.js";import{f as v,a as m,c as p,e as w,d as f,b as u,I as b}from"./IconSocialReddit-C_njn4em.js";import{I as x}from"./IconClose-BD6-dXf8.js";import{I}from"./IconDropdown-Bsl9sJbQ.js";import{I as z}from"./IconExternal-D74KcMPJ.js";import{I as T}from"./IconInfo-D1-JT0wp.js";import{I as M}from"./IconLocation-CUyqMFQl.js";import{I as S}from"./IconMenu-DV0OjQIk.js";import{a as H,I as V}from"./IconPrev-yIQlxMWd.js";import{I as C}from"./IconPlus-8-RyMFvs.js";import{I as L}from"./IconSearch-B_HupseB.js";import{I as y}from"./IconUser-CqYZ7HgZ.js";const k=({customClass:e})=>(e||(e=""),`
    <svg
      class="Icon360 ${e}"
      width="40"
      height="40"
  ...
  `),E2={title:"Foundation/Icons",argTypes:{customClass:{type:"string",description:"Use Tailwind CSS text size, color and background classes to control the icon styling. Icon dimensions are set in `em`s to allow for relative sizing.",control:{type:"text"}}},parameters:{viewMode:"docs",docs:{description:{component:'Icons are rendered by inserting their SVG markup directly into the DOM. We encourage taking advantage of your templating system to do this in a more developer-friendly way than copying and pasting the entire HTML code. For example, in our Django templates, we store the SVG markup in individual template files and then insert it with Django’s `include` tag, like so: `{% include "components/Icons/IconClose.html" %}`.\n\nIcon size and color are handled by Tailwind CSS text classes. These can be applied directly to the `<svg>` element or to a wrapping element.'}}}},t={customClass:"text-base text-black"},a={customClass:"text-base text-white bg-jpl-red"},X=d.bind();X.args=t;const W=g.bind();W.args=t;const J=$.bind();J.args=t;const K=v.bind();K.args=t;const Q=A.bind();Q.args=t;const Z=P.bind();Z.args=t;const e2=x.bind();e2.args=t;const t2=F.bind();t2.args=t;const o2=h.bind();o2.args=t;const a2=I.bind();a2.args=t;const r2=z.bind();r2.args=t;const n2=D.bind();n2.args=t;const i2=E.bind();i2.args=t;const s2=T.bind();s2.args=t;const l2=j.bind();l2.args=t;const c2=M.bind();c2.args=t;const d2=S.bind();d2.args=t;const h2=G.bind();h2.args=t;const g2=C.bind();g2.args=t;const v2=L.bind();v2.args=t;const m2=O.bind();m2.args=t;const p2=y.bind();p2.args=t;const w2=q.bind();w2.args={customClass:"text-base text-black"};const f2=m.bind();f2.args={customClass:"text-base text-facebook"};const u2=p.bind();u2.args={customClass:"text-base text-instagram"};const b2=w.bind();b2.args={customClass:"text-base text-reddit"};const x2=f.bind();x2.args={customClass:"text-base text-youtube"};const I2=u.bind();I2.args={customClass:"text-base text-twitter"};const o=H.bind();o.args=a;o.parameters={docs:{description:{story:"This icon includes padding for a square dimension"}}};const r=V.bind();r.args=a;r.parameters=o.parameters;const n=b.bind();n.args=a;n.parameters=o.parameters;const i=B.bind();i.args=a;i.parameters=o.parameters;const s=U.bind();s.args=a;s.parameters=o.parameters;const l=N.bind();l.args=a;l.parameters=o.parameters;const z2=Y.bind();z2.args={customClass:"text-sm text-jpl-red"};const T2=_.bind();T2.args={customClass:"text-base text-jpl-red"};const M2=R.bind();M2.args={customClass:"text-base text-jpl-red"};const c=k.bind();c.args=a;c.parameters=o.parameters;const j2=["Arrow","Arrows","Calendar","Caret","Checkbox","CheckboxSelected","Close","CloseLightbox","Download","Dropdown","External","Filter","Grid","Info","List","Location","Menu","Minus","Plus","Search","Time","User","SocialEmail","SocialFacebook","SocialInstagram","SocialReddit","SocialYoutube","SocialX","Prev","Next","Expand","Audio","Play","Pause","Stop","Volume","Mute","ThreeSixty"];export{X as Arrow,W as Arrows,i as Audio,J as Calendar,K as Caret,Q as Checkbox,Z as CheckboxSelected,e2 as Close,t2 as CloseLightbox,o2 as Download,a2 as Dropdown,n as Expand,r2 as External,n2 as Filter,i2 as Grid,s2 as Info,l2 as List,c2 as Location,d2 as Menu,h2 as Minus,M2 as Mute,r as Next,l as Pause,s as Play,g2 as Plus,o as Prev,v2 as Search,w2 as SocialEmail,f2 as SocialFacebook,u2 as SocialInstagram,b2 as SocialReddit,I2 as SocialX,x2 as SocialYoutube,z2 as Stop,c as ThreeSixty,m2 as Time,p2 as User,T2 as Volume,j2 as __namedExportsOrder,E2 as default};
