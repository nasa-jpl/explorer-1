import{B as n}from"./BaseLink-BM1wc07I.js";import{B as s}from"./BaseButton-DpIDzJwf.js";const o=({title:t,items:e})=>{t||(t=""),e||(e=[]);let l="";if(e.length>0){l='<ul class="flex flex-wrap">';for(const[a,r]of e.entries())l+=`<li class="flex flex-nowrap mr-2">${n({variant:"none",linkClass:"text-jpl-sky-blue can-hover:hover:text-jpl-sky-blue-dark",text:r.name,link:`mailto:${r.email}`})}
      ${a+1===e.length?"":","}
      </li>`;l+="</ul>"}return`
