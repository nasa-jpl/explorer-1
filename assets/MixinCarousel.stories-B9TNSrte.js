import{M as s}from"./MixinCarousel-nE186pdP.js";const c={title:"Mixins/MixinCarousel",component:s,tags:["autodocs","carousels"]},e={name:"BaseCarousel",args:{heading:"Heading",variant:"tiles"},render:i=>({components:{MixinCarousel:s},setup(){return{args:i}},template:`<MixinCarousel v-bind="args">
