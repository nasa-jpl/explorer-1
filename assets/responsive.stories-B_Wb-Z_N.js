const a={title:"Guides/Responsive Design",tags:["!autodocs"]},o=()=>`<div class="bg-gray-light border">
  <code>body</code>
...
</div>`,e={render:o.bind({})};var r,d,s;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: ResponsiveDesignTemplate.bind({})
}`,...(s=(d=e.parameters)==null?void 0:d.docs)==null?void 0:s.source}}};const t=["Demo"],i=Object.freeze(Object.defineProperty({__proto__:null,Demo:e,__namedExportsOrder:t,default:a},Symbol.toStringTag,{value:"Module"}));export{e as D,i as S};
