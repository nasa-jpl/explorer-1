import{j as e}from"./jsx-runtime-BtSn_OcB.js";import{u as r}from"./index-erqFjWAZ.js";import{M as a,C as s}from"./index-BRR2Yx3h.js";import{S as h,I as l,A as i}from"./themes.stories-DS1NRvU7.js";import"./iframe-CgCDD2BL.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./chunk-ZHZY55TS-BSmtHhVf.js";import"./index-DvzDrELh.js";import"./index-DrFu-skq.js";function o(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{of:h}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"ThemeLight"})," is the default"]}),`
`,e.jsx(n.li,{children:"It is recommended that page templates always include the default theme."}),`
`,e.jsxs(n.li,{children:["If a page theme is controllable by a site editor, then include appropriate class bindings to switch between ",e.jsx(n.code,{children:".ThemeLight"})," or ",e.jsx(n.code,{children:".ThemeDark"})]}),`
...
`,e.jsxs(n.p,{children:["Storybook can mimic these theme choices. All stories are wrapped in ",e.jsx(n.code,{children:"ThemeLight"})," by default. You can switch to ",e.jsx(n.code,{children:"ThemeDark"})," on any story by using the toolbar menu (the icon looks like a picture). ",e.jsxs(n.strong,{children:['Note that most components do not have a dark theme, and thus will appear "broken" when viewed with ',e.jsx(n.code,{children:"ThemeDark"}),"."]})]}),`
...
`,e.jsxs(n.p,{children:["For components that have light and dark themes, add theme rules to the end of your scss. The following is an example of a component whose background should be ",e.jsx(n.code,{children:"bg-white"})," by default and in ",e.jsx(n.code,{children:"ThemeLight"})," but ",e.jsx(n.code,{children:"bg-black"})," in ",e.jsx(n.code,{children:"ThemeDark"})]}),`
...
`,e.jsx(s,{of:i}),`
`,e.jsxs(n.p,{children:["See ",e.jsx(n.a,{href:"?path=/docs/components-base-baselink--docs",children:"BaseLink"})," for a real usage example."]})]})}function y(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{y as default};
