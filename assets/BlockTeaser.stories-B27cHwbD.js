import{B as m}from"./BaseImage-D_GSeSF-.js";import{B as u}from"./BaseButton-CkSNoISR.js";const a=({fullWidthImage:e,image:t,label:s,heading:o,introduction:i,buttonText:h,link:g})=>{let l="";if(o){let n=s?"h3":"h2";l=`<${n} class="text-h3 font-semibold tracking-normal lg:mt-2 mt-3">`+o+`</${n}>`}return t=t&&e?t.full:t?t.half:"",`
