import{M as i}from"./MixinCarousel-DM-WPoSR.js";const s={title:"Mixins/MixinCarousel",component:i,tags:["autodocs","carousels"]},a={name:"BaseCarousel",args:{heading:"Heading",variant:"tiles"},render:e=>({components:{MixinCarousel:i},setup(){return{args:e}},template:`<MixinCarousel v-bind="args">
