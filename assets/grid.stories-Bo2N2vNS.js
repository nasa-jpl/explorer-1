import{L as c}from"./LayoutHelper-hmng7OlB.js";const l={title:"Foundations/Grid and Layout",component:c,tags:["!autodocs"]},e={args:{},render:()=>({template:`<div class="max-w-screen-3xl mx-auto">
...
}`,...s.parameters?.docs?.source}}};const o=["BaseGrid","ComponentA","ComponentB","MixedBleedGridLines","MixedBleed","MixedBleedComplex","PageLayout","FullPageExample"],b=Object.freeze(Object.defineProperty({__proto__:null,BaseGrid:e,ComponentA:t,ComponentB:d,FullPageExample:s,MixedBleed:r,MixedBleedComplex:a,MixedBleedGridLines:i,PageLayout:n,__namedExportsOrder:o,default:l},Symbol.toStringTag,{value:"Module"}));export{e as B,t as C,s as F,i as M,n as P,b as S,d as a,r as b,a as c};
