const e={title:"Foundation/Grid and Layout",tags:["!autodocs"]},t=()=>`<div class="max-w-screen-3xl mx-auto">
...
</div>`,d={render:t.bind({})},i=()=>`<div class="BaseGrid container mx-auto border border-jpl-red-light">
  <div class="col-start-4 col-end-10 bg-black text-white px-4 py-10">
    Starts at col 4 and ends at the col 10 line.
  </div>
</div>`,a={render:i.bind({})},r=()=>`<div class="BaseGrid container mx-auto border border-jpl-red-light">
...
</div>`,l={render:r.bind({})},c=()=>`<div class="max-w-screen-3xl mx-auto bg-white">
...
</div>`,s={render:c.bind({})},o=()=>`<div class="MixedBleedGrid">
...
</div>`,b={render:v.bind({})},g=()=>`<!-- first section -->
...
</div>`,x={render:g.bind({})},m=()=>`<div class="bg-black text-white py-5 mb-10">
...
</div>`,p={render:m.bind({})},y=["BaseGrid","ComponentA","ComponentB","MixedBleedGridLines","MixedBleed","MixedBleedComplex","PageLayout","FullPageExample"],h=Object.freeze(Object.defineProperty({__proto__:null,BaseGrid:d,ComponentA:a,ComponentB:l,FullPageExample:p,MixedBleed:n,MixedBleedComplex:b,MixedBleedGridLines:s,PageLayout:x,__namedExportsOrder:y,default:e},Symbol.toStringTag,{value:"Module"}));export{d as B,a as C,p as F,s as M,x as P,h as S,l as a,n as b,b as c};
