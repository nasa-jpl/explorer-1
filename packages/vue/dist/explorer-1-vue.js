import { defineComponent as k, openBlock as v, createBlock as A, resolveDynamicComponent as gt, normalizeClass as L, withCtx as M, createElementVNode as w, renderSlot as S, createElementBlock as T, resolveComponent as R, createVNode as q, createCommentVNode as mt, createStaticVNode as bt } from "vue";
const Q = {
  primary: "-primary",
  secondary: "-secondary",
  dark: "-dark",
  ...
  computed: {
    ...
    variantClass() {
      ...
      return !this.$slots.default && this.$slots.icon ? n = n + " -icon-only" : this.compact && (n = n + " -compact"), this.blockClasses && (n = n + " " + this.blockClasses), n;
    }
  }
}), _ = (n, t) => {
...
const be = /* @__PURE__ */ _(yt, [["render", xt]]), wt = k({
  name: "IconCaret"
}), $t = {
  class: "IconCaret",
  width: "8",
...
const Lt = /* @__PURE__ */ _(wt, [["render", Et]]), Pt = k({
  ...
  computed: {
    computedClass() {
      let n = "";
      return this.passedWrapperClass && (n = n + " " + this.passedWrapperClass), this.inline && (n = n + " caret-inline"), n;
    }
  }
}), Tt = { class: "arrow" }, kt = { class: "arrow-fixed" };
...
const zt = /* @__PURE__ */ _(Pt, [["render", _t]]), tt = {
  primary: "text-subtitle text-action-color hover:text-action-color-dark dark:text-action-color-light dark:hover:text-action-color",
  secondary: "text-subtitle text-action-color hover:text-action-color-dark dark:text-action-color-light dark:hover:text-action-color",
  default: "-default underline text-action-color hover:text-action-color-dark dark:text-action-color-light dark:hover:text-action-color",
  none: ""
}, At = k({
  ...
  computed: {
    computedClass() {
      ...
      return (this.to || this.href) && (n = n + " cursor-pointer"), this.linkClass && (n = n + " " + this.linkClass), n;
    },
    theTarget() {
      if (this.target)
        return this.target;
...
function Ot(n, t, e, i, s, o) {
  const a = R("MixinAnimationCaret"), r = R("nuxt-link");
  return v(), T("div", null, [
    n.to ? (v(), A(r, {
      key: 0,
      ...
      default: M(() => [
        n.caretInline && n.caret ? (v(), A(a, {
          ...
          _: 3
        }, 8, ["class", "arrow-class", "color", "margin-left"])) : n.variant === "primary" || n.caret ? (v(), A(a, {
          key: 1,
          class: L(n.caretWrapperClass),
          "arrow-class": n.caretClass,
          color: n.caretColor,
          ...
          _: 3
        }, 8, ["class", "arrow-class", "color", "margin-left"])) : S(n.$slots, "default", { key: 2 })
      ]),
      _: 3
    }, 8, ["class", "to", "target", "rel", "aria-label", "title", "exact"])) : n.href ? (v(), T("a", {
      key: 1,
      href: n.href,
      class: L(["group", n.computedClass]),
      target: n.theTarget,
...
const ye = /* @__PURE__ */ _(At, [["render", Ot]]), It = k({
  name: "IconArrows"
}), Ft = {
  class: "IconArrows",
  width: "32",
  ...
  "aria-hidden": "true",
  focusable: "false"
}, Bt = /* @__PURE__ */ bt('<g fill="currentColor" fill-rule="evenodd"><path d="M4 11.657l-.707-.707L8.243 6l-4.95-4.95L4 .343 9.657 6 4 11.657z" transform="translate(2)"></path><path d="M10 11.657l-.707-.707L14.243 6l-4.95-4.95L10 .343 15.657 6 10 11.657z" transform="translate(2)"></path><path d="M16 11.657l-.707-.707L20.243 6l-4.95-4.95L16 .343 21.657 6 16 11.657z" transform="translate(2)"></path><path d="M22 11.657l-.707-.707L26.243 6l-4.95-4.95L22 .343 27.657 6 22 11.657z" transform="translate(2)"></path></g>', 1), Nt = [
  Bt
];
function Dt(n, t, e, i, s, o) {
  return v(), T("svg", Ft, Nt);
}
const Rt = /* @__PURE__ */ _(It, [["render", Dt]]), Ht = k({
  name: "IconLocation"
}), qt = {
  class: "IconLocation",
  width: "16",
...
const ve = /* @__PURE__ */ _(Ht, [["render", Vt]]), Ut = k({
  name: "IconArrows"
}), Yt = {
  class: "IconUser",
  width: "21",
...
const xe = /* @__PURE__ */ _(Ut, [["render", Gt]]), O = (n) => typeof n == "object" && n !== null && n.constructor === Object && Object.prototype.toString.call(n) === "[object Object]", x = (...n) => {
  let t = !1;
  typeof n[0] == "boolean" && (t = n.shift());
  let e = n[0];
  if (!e || typeof e != "object")
    throw new Error("extendee must be an object");
  const i = n.slice(1), s = i.length;
  for (let o = 0; o < s; o++) {
    const a = i[o];
    for (let r in a)
  ...
  return e;
}, y = (n, t = 1e4) => (n = parseFloat(n) || 0, Math.round((n + Number.EPSILON) * t) / t), W = function(n) {
  return !!(n && typeof n == "object" && n instanceof Element && n !== document.body) && !n.__Panzoom && (function(t) {
    const e = getComputedStyle(t)["overflow-y"], i = getComputedStyle(t)["overflow-x"], s = (e === "scroll" || e === "auto") && Math.abs(t.scrollHeight - t.clientHeight) > 1, o = (i === "scroll" || i === "auto") && Math.abs(t.scrollWidth - t.clientWidth) > 1;
    return s || o;
  }(n) ? n : W(n.parentNode));
}, Kt = typeof window < "u" && window.ResizeObserver || class {
  constructor(n) {
    this.observables = [], this.boundCheck = this.check.bind(this), this.boundCheck(), this.callback = n;
  }
  observe(n) {
    if (this.observables.some((e) => e.el === n))
      return;
  ...
  check() {
    const n = this.observables.filter((t) => {
...
const et = (n, t) => t ? Math.sqrt((t.clientX - n.clientX) ** 2 + (t.clientY - n.clientY) ** 2) : 0, V = (n, t) => t ? { clientX: (n.clientX + t.clientX) / 2, clientY: (n.clientY + t.clientY) / 2 } : n;
class Jt {
  constructor(t, { start: e = () => !0, move: i = () => {
  }, end: s = () => {
  } } = {}) {
    this._element = t, this.startPointers = [], this.currentPointers = [], this._pointerStart = (o) => {
      if (o.buttons > 0 && o.button !== 0)
        return;
      const a = new z(o);
      this.currentPointers.some((r) => r.id === a.id) || this._triggerPointerStart(a, o) && (window.addEventListener("mousemove", this._move), window.addEventListener("mouseup", this._pointerEnd));
    }, this._touchStart = (o) => {
      for (const a of Array.from(o.changedTouches || []))
        this._triggerPointerStart(new z(a), o);
    }, this._move = (o) => {
      const a = this.currentPointers.slice(), r = ((l) => "changedTouches" in l)(o) ? Array.from(o.changedTouches).map((l) => new z(l)) : [new z(o)];
      for (const l of r) {
      ...
      return !(r < 0) && (this.currentPointers.splice(r, 1), this.startPointers.splice(r, 1), this._endCallback(o, a), !0);
    }, this._pointerEnd = (o) => {
      o.buttons > 0 && o.button !== 0 || this._triggerPointerEnd(new z(o), o) && (window.removeEventListener("mousemove", this._move, { passive: !1 }), window.removeEventListener("mouseup", this._pointerEnd, { passive: !1 }));
    }, this._touchEnd = (o) => {
      for (const a of Array.from(o.changedTouches || []))
        this._triggerPointerEnd(new z(a), o);
...
class j {
  ...
  option(t, e, ...i) {
    t = String(t);
    let s = (o = t, a = this.options, o.split(".").reduce(function(r, l) {
      return r && r[l];
    }, a));
    var o, a;
  ...
  localize(t, e = []) {
    return t = (t = String(t).replace(/\{\{(\w+).?(\w+)?\}\}/g, (i, s, o) => {
      let a = "";
      o ? a = this.option(`${s[0] + s.toLowerCase().substring(1)}.l10n.${o}`) : s && (a = this.option(`l10n.${s}`)), a || (a = i);
  ...
  attachPlugins(t) {
    ...
    for (const [i, s] of Object.entries(t || {}))
      this.options[i] === !1 || this.plugins[i] || (this.options[i] = x({}, s.defaults || {}, this.options[i]), e[i] = new s(this));
...
const Qt = { touch: !0, zoom: !0, pinchToZoom: !0, panOnlyZoomed: !1, lockAxis: !1, friction: 0.64, decelFriction: 0.88, zoomFriction: 0.74, bounceForce: 0.2, baseScale: 1, minScale: 1, maxScale: 2, step: 0.5, textSelection: !1, click: "toggleZoom", wheel: "zoom", wheelFactor: 42, wheelLimit: 5, draggableClass: "is-draggable", draggingClass: "is-dragging", ratio: 1 };
class I extends j {
  constructor(t, e = {}) {
    super(x(!0, {}, Qt, e)), this.state = "init", this.$container = t;
    for (const i of ["onLoad", "onWheel", "onClick"])
      this[i] = this[i].bind(this);
    this.initLayout(), this.resetValues(), this.attachPlugins(I.Plugins), this.trigger("init"), this.updateMetrics(), this.attachEvents(), this.trigger("ready"), this.option("centerOnStart") === !1 ? this.state = "ready" : this.panTo({ friction: 0 }), t.__Panzoom = this;
  }
  initLayout() {
  ...
  zoomWithWheel(t) {
    ...
    if (e < 0 && Math.abs(i - this.option("minScale")) < 0.01 || e > 0 && Math.abs(i - this.option("maxScale")) < 0.01 ? (this.changedDelta += Math.abs(e), s = i) : (this.changedDelta = 0, s = Math.max(Math.min(s, this.option("maxScale")), this.option("minScale"))), this.changedDelta > this.option("wheelLimit") || (t.preventDefault(), s === i))
      return;
    const o = this.$content.getBoundingClientRect(), a = t.clientX - o.left, r = t.clientY - o.top;
  ...
  attachEvents() {
    ...
    const t = new Jt(this.$container, { start: (e, i) => {
      if (!this.option("touch") || this.velocity.scale < 0)
        return !1;
      const s = i.composedPath()[0];
      return !t.currentPointers.length && (["BUTTON", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(s.nodeName) !== -1 || this.option("textSelection") && ((o, a, r) => {
        const l = o.childNodes, h = document.createRange();
        for (let c = 0; c < l.length; c++) {
          ...
          if (a >= f.left && r >= f.top && a <= f.right && r <= f.bottom)
            return u;
        }
        return !1;
      })(s, e.clientX, e.clientY)) ? !1 : !W(s) && this.trigger("touchStart", i) !== !1 && (i.type === "mousedown" && i.preventDefault(), this.state = "pointerdown", this.resetDragPosition(), this.dragPosition.midPoint = null, this.dragPosition.time = Date.now(), !0);
    }, move: (e, i, s) => {
      if (this.state !== "pointerdown")
        return;
      if (this.trigger("touchMove", s) === !1)
      ...
      if (i.length < 2 && this.option("panOnlyZoomed") === !0 && this.content.width <= this.viewport.width && this.content.height <= this.viewport.height && this.transform.scale <= this.option("baseScale") || i.length > 1 && (!this.option("zoom") || this.option("pinchToZoom") === !1))
        return;
      const o = V(e[0], e[1]), a = V(i[0], i[1]), r = a.clientX - o.clientX, l = a.clientY - o.clientY, h = et(e[0], e[1]), c = et(i[0], i[1]), u = h && c ? c / h : 1;
      ...
      if (f === "xy" || this.lockAxis !== "y") {
        if (s.preventDefault(), s.stopPropagation(), s.stopImmediatePropagation(), this.lockAxis && (this.dragOffset[this.lockAxis === "x" ? "y" : "x"] = 0), this.$container.classList.add(this.option("draggingClass")), this.transform.scale === this.option("baseScale") && this.lockAxis === "y" || (this.dragPosition.x = this.dragStart.x + this.dragOffset.x), this.transform.scale === this.option("baseScale") && this.lockAxis === "x" || (this.dragPosition.y = this.dragStart.y + this.dragOffset.y), this.dragPosition.scale = this.dragStart.scale * this.dragOffset.scale, i.length > 1) {
          const d = V(t.startPointers[0], t.startPointers[1]), p = d.clientX - this.dragStart.rect.x, m = d.clientY - this.dragStart.rect.y, { deltaX: b, deltaY: E } = this.getZoomDelta(this.content.scale * this.dragOffset.scale, p, m);
          this.dragPosition.x -= b, this.dragPosition.y -= E, this.dragPosition.midPoint = a;
        } else
  ...
  initObserver() {
    this.resizeObserver || (this.resizeObserver = new Kt(() => {
  ...
  updateMetrics(t) {
    ...
    const e = this.$container, i = this.$content, s = this.$viewport, o = i instanceof HTMLImageElement, a = this.option("zoom"), r = this.option("resizeParent", a);
    ...
    var u;
    let f = h || (($) => Math.max(parseFloat($.naturalHeight || 0), parseFloat($.height && $.height.baseVal && $.height.baseVal.value || 0), parseFloat($.offsetHeight || 0), parseFloat($.scrollHeight || 0)))(i);
    Object.assign(i.style, { width: l ? `${l}px` : "", height: h ? `${h}px` : "", maxWidth: "", maxHeight: "" }), r && Object.assign(s.style, { width: "", height: "" });
    const d = this.option("ratio");
    c = y(c * d), f = y(f * d), l = c, h = f;
    const p = i.getBoundingClientRect(), m = s.getBoundingClientRect(), b = s == e ? m : e.getBoundingClientRect();
    let E = Math.max(s.offsetWidth, y(m.width)), Z = Math.max(s.offsetHeight, y(m.height)), H = window.getComputedStyle(s);
    if (E -= parseFloat(H.paddingLeft) + parseFloat(H.paddingRight), Z -= parseFloat(H.paddingTop) + parseFloat(H.paddingBottom), this.viewport.width = E, this.viewport.height = Z, a) {
    ...
    if (r && (Object.assign(s.style, { width: `${l}px`, height: `${h}px` }), this.viewport = { ...this.viewport, width: l, height: h }), o && a && typeof this.options.maxScale != "function") {
      const $ = this.option("maxScale");
      this.options.maxScale = function() {
        return this.content.origWidth > 0 && this.content.fitWidth > 0 ? this.content.origWidth / this.content.fitWidth : $;
      };
    }
    this.content = { ...this.content, origWidth: c, origHeight: f, fitWidth: l, fitHeight: h, width: l, height: h, scale: 1, isZoomable: a }, this.container = { width: b.width, height: b.height }, t !== !0 && this.trigger("afterUpdate");
  }
  zoomIn(t) {
  ...
  toggleZoom(t = {}) {
    const e = this.option("maxScale"), i = this.option("baseScale"), s = this.content.scale > i + 0.5 * (e - i) ? i : e;
    this.zoomTo(s, t);
  }
  zoomTo(t = this.option("baseScale"), { x: e = null, y: i = null } = {}) {
    ...
    e === null && (e = this.content.width * s * 0.5), i === null && (i = this.content.height * s * 0.5);
    const { deltaX: o, deltaY: a } = this.getZoomDelta(t, e, i);
    e = this.content.x - o, i = this.content.y - a, this.panTo({ x: e, y: i, scale: t, friction: this.option("zoomFriction") });
  }
  getZoomDelta(t, e = 0, i = 0) {
    const s = this.content.fitWidth * this.content.scale, o = this.content.fitHeight * this.content.scale, a = e > 0 && s ? e / s : 0, r = i > 0 && o ? i / o : 0;
    return { deltaX: (this.content.fitWidth * t - s) * a, deltaY: (this.content.fitHeight * t - o) * r };
  }
  panTo({ x: t = this.content.x, y: e = this.content.y, scale: i, friction: s = this.option("friction"), ignoreBounds: o = !1 } = {}) {
    ...
    this.friction = s, this.transform = { ...this.transform, x: t, y: e, scale: i }, s ? (this.state = "panning", this.velocity = { x: (1 / this.friction - 1) * (t - this.content.x), y: (1 / this.friction - 1) * (e - this.content.y), scale: (1 / this.friction - 1) * (i - this.content.scale) }, this.startAnimation()) : this.endAnimation();
  }
  startAnimation() {
  ...
  getBounds(t) {
    ...
    const s = this.content.fitWidth * t, o = this.content.fitHeight * t, a = this.viewport.width, r = this.viewport.height;
    if (s < a) {
      const l = y(0.5 * (a - s));
      e.from = l, e.to = l;
    } else
  ...
  setEdgeForce() {
    ...
    let s, o, a, r;
    if (e && (s = this.content.x < e.from, o = this.content.x > e.to), i && (a = this.content.y < i.from, r = this.content.y > i.to), s || o) {
  ...
  setDragResistance() {
    ...
    let i, s, o, a;
    if (t && (i = this.dragPosition.x < t.from, s = this.dragPosition.x > t.to), e && (o = this.dragPosition.y < e.from, a = this.dragPosition.y > e.to), (i || s) && (!i || !s)) {
      const r = i ? t.from : t.to, l = r - this.dragPosition.x;
      this.dragPosition.x = r - 0.3 * l;
    }
    if ((o || a) && (!o || !a)) {
      const r = o ? e.from : e.to, l = r - this.dragPosition.y;
  ...
  setTransform(t) {
    let e, i, s;
    if (t ? (e = y(this.transform.x), i = y(this.transform.y), s = this.transform.scale, this.content = { ...this.content, x: e, y: i, scale: s }) : (e = y(this.content.x), i = y(this.content.y), s = this.content.scale / (this.content.width / this.content.fitWidth), this.content = { ...this.content, x: e, y: i }), this.trigger("beforeTransform"), e = y(this.content.x), i = y(this.content.y), t && this.option("zoom")) {
      let o, a;
      o = y(this.content.fitWidth * s), a = y(this.content.fitHeight * s), this.content.width = o, this.content.height = a, this.transform = { ...this.transform, width: o, height: a, scale: s }, Object.assign(this.$content.style, { width: `${o}px`, height: `${a}px`, maxWidth: "none", maxHeight: "none", transform: `translate3d(${e}px, ${i}px, 0) scale(1)` });
    } else
...
class nt {
  ...
  createButton(t) {
    ...
    return e.classList.add(...i.split(" ")), e.setAttribute("tabindex", "0"), e.innerHTML = this.carousel.localize(this.option(`${t}Tpl`)), e.addEventListener("click", (s) => {
      s.preventDefault(), s.stopPropagation(), this.carousel["slide" + (t === "next" ? "Next" : "Prev")]();
    }), e;
  }
  build() {
...
nt.defaults = { prevTpl: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" tabindex="-1"><path d="M15 3l-9 9 9 9"/></svg>', nextTpl: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" tabindex="-1"><path d="M9 3l9 9-9 9"/></svg>', classNames: { main: "carousel__nav", button: "carousel__button", next: "is-next", prev: "is-prev" } };
class at {
  constructor(t) {
  ...
  onNavClick(t, e, i) {
    ...
    if (!s)
      return;
    i.stopPropagation();
    const o = parseInt(s.dataset.index, 10), a = this.target.findPageForSlide(o);
...
const te = { Navigation: nt, Dots: class {
  constructor(n) {
    this.carousel = n, this.$list = null, this.events = { change: this.onChange.bind(this), refresh: this.onRefresh.bind(this) };
  }
  buildList() {
    if (this.carousel.pages.length < this.carousel.option("Dots.minSlideCount"))
      return;
    const n = document.createElement("ol");
    return n.classList.add("carousel__dots"), n.addEventListener("click", (t) => {
    ...
    }), this.$list = n, this.carousel.$container.appendChild(n), this.carousel.$container.classList.add("has-dots"), n;
  }
  removeList() {
  ...
  rebuildDots() {
    let n = this.$list;
    const t = !!n, e = this.carousel.pages.length;
    if (e < 2)
    ...
    if (i > e)
      ...
      for (let s = i; s < e; s++) {
        ...
        o.classList.add("carousel__dot"), o.dataset.page = s, o.setAttribute("role", "button"), o.setAttribute("tabindex", "0"), o.setAttribute("title", this.carousel.localize("{{GOTO}}", [["%d", s + 1]])), o.addEventListener("keydown", (a) => {
          const r = a.code;
          let l;
          r === "Enter" || r === "NumpadEnter" ? l = o : r === "ArrowRight" ? l = o.nextSibling : r === "ArrowLeft" && (l = o.previousSibling), l && l.click();
...
}, Sync: at }, ee = { slides: [], preload: 0, slidesPerPage: "auto", initialPage: null, initialSlide: null, friction: 0.92, center: !0, infinite: !0, fill: !0, dragFree: !1, prefix: "", classNames: { viewport: "carousel__viewport", track: "carousel__track", slide: "carousel__slide", slideSelected: "is-selected" }, l10n: { NEXT: "Next slide", PREV: "Previous slide", GOTO: "Go to slide #%d" } };
class F extends j {
  constructor(t, e = {}) {
    if (super(e = x(!0, {}, ee, e)), this.state = "init", this.$container = t, !(this.$container instanceof HTMLElement))
      throw new Error("No root element provided");
    this.slideNext = it(this.slideNext.bind(this), 250), this.slidePrev = it(this.slidePrev.bind(this), 250), this.init(), t.__Carousel = this;
  }
  init() {
    this.pages = [], this.page = this.pageIndex = null, this.prevPage = this.prevPageIndex = null, this.attachPlugins(F.Plugins), this.trigger("init"), this.initLayout(), this.initSlides(), this.updateMetrics(), this.$track && this.pages.length && (this.$track.style.transform = `translate3d(${-1 * this.pages[this.page].left}px, 0px, 0) scale(1)`), this.manageSlideVisiblity(), this.initPanzoom(), this.state = "ready", this.trigger("ready");
  }
  initLayout() {
  ...
  initSlides() {
    ...
    }), Array.isArray(this.options.slides) && (this.slides = x(!0, [...this.slides], this.options.slides));
  }
  updateMetrics() {
    let t, e = 0, i = [];
    this.slides.forEach((d, p) => {
      const m = d.$el, b = d.isDom || !t ? this.getSlideMetrics(m) : t;
      d.index = p, d.width = b, d.left = e, t = b, e += b, i.push(p);
    });
    let s = Math.max(this.$track.offsetWidth, y(this.$track.getBoundingClientRect().width)), o = getComputedStyle(this.$track);
    s -= parseFloat(o.paddingLeft) + parseFloat(o.paddingRight), this.contentWidth = e, this.viewportWidth = s;
    ...
    if (Number.isInteger(r) && e > s)
      ...
      for (let m = 0; m < this.slides.length; m += 1) {
        let b = this.slides[m];
        (!a.length || p + b.width > s) && (a.push({ indexes: [], slides: [] }), d = a.length - 1, p = 0), p += b.width, a[d].indexes.push(m), a[d].slides.push(b);
      }
    }
    const l = this.option("center"), h = this.option("fill");
    a.forEach((d, p) => {
      d.index = p, d.width = d.slides.reduce((m, b) => m + b.width, 0), d.left = d.slides[0].left, l && (d.left += 0.5 * (s - d.width) * -1), h && !this.option("infiniteX", this.option("infinite")) && e > s && (d.left = Math.max(d.left, 0), d.left = Math.min(d.left, e - s));
    });
    const c = [];
    let u;
    a.forEach((d) => {
      const p = { ...d };
      u && p.left === u.left ? (u.width += p.width, u.slides = [...u.slides, ...p.slides], u.indexes = [...u.indexes, ...p.indexes]) : (p.index = c.length, u = p, c.push(p));
    }), this.pages = c;
    let f = this.page;
    if (f === null) {
      const d = this.option("initialSlide");
      f = d !== null ? this.findPageForSlide(d) : parseInt(this.option("initialPage", 0), 10) || 0, c[f] || (f = c.length && f > c.length ? c[c.length - 1].index : 0), this.page = f, this.pageIndex = f;
    }
  ...
  getSlideMetrics(t) {
    if (!t) {
      ...
      (t = document.createElement("div")).dataset.isTestEl = 1, t.style.visibility = "hidden", t.classList.add(...(this.option("prefix") + this.option("classNames.slide")).split(" ")), s.customClass && t.classList.add(...s.customClass.split(" ")), this.$track.prepend(t);
    }
  ...
  slideTo(t, e = {}) {
    ...
    this.Panzoom.content.x === i && !this.Panzoom.velocity.x && o || (this.Panzoom.panTo({ x: i, y: s, friction: o, ignoreBounds: !0 }), this.state === "ready" && this.Panzoom.state === "ready" && this.trigger("settle"));
  }
  initPanzoom() {
    this.Panzoom && this.Panzoom.destroy();
    const t = x(!0, {}, { content: this.$track, wrapInner: !1, resizeParent: !1, zoom: !1, click: !1, lockAxis: "x", x: this.pages.length ? -1 * this.pages[this.page].left : 0, centerOnStart: !1, textSelection: () => this.option("textSelection", !1), panOnlyZoomed: function() {
      return this.content.width <= this.viewport.width;
    } }, this.option("Panzoom"));
    this.Panzoom = new I(this.$container, t), this.Panzoom.on({ "*": (e, ...i) => this.trigger(`Panzoom.${e}`, ...i), afterUpdate: () => {
      this.updatePage();
  ...
  manageSlideVisiblity() {
    ...
    const s = this.option("preload"), o = this.option("infiniteX", this.option("infinite")), a = parseFloat(getComputedStyle(this.$viewport, null).getPropertyValue("padding-left")), r = parseFloat(getComputedStyle(this.$viewport, null).getPropertyValue("padding-right"));
    this.slides.forEach((c) => {
      ...
      m || p || b ? (this.createSlideEl(c), p && (d = 0), m && (d = -1), b && (d = 1), c.left + c.width > i && c.left <= i + e + r && (d = 0)) : this.removeSlideEl(c), c.hasDiff = d;
    });
    let l = 0, h = 0;
    this.slides.forEach((c, u) => {
      let f = 0;
      c.$el ? (u !== l || c.hasDiff ? f = h + c.hasDiff * t : h = 0, c.$el.style.left = Math.abs(f) > 0.1 ? `${h + c.hasDiff * t}px` : "", l++) : h += c.width;
  ...
  markSelectedSlides() {
    ...
    this.slides.forEach((i, s) => {
      ...
      a && a.indexes && a.indexes.indexOf(s) > -1 ? (t && !o.classList.contains(t) && (o.classList.add(t), this.trigger("selectSlide", i)), o.removeAttribute(e)) : (t && o.classList.contains(t) && (o.classList.remove(t), this.trigger("unselectSlide", i)), o.setAttribute(e, !0));
    });
  }
  updatePage() {
  ...
  manageInfiniteTrack() {
    ...
    let s = !1;
    return i.content.x < -1 * (t - e) && (i.content.x += t, this.pageIndex = this.pageIndex - this.pages.length, s = !0), i.content.x > e && (i.content.x -= t, this.pageIndex = this.pageIndex + this.pages.length, s = !0), s && i.state === "pointerdown" && i.resetDragPosition(), s;
  }
  onTouchEnd(t, e) {
  ...
  setPage(t, e) {
    ...
    const o = this.page, a = this.pageIndex, r = this.pages.length, l = this.contentWidth, h = this.viewportWidth;
    if (t = (s % r + r) % r, this.option("infiniteX", this.option("infinite")) && l > h) {
      const c = Math.floor(s / r) || 0, u = l;
      if (i = this.pages[t].left + c * u, e === !0 && r > 2) {
        let f = -1 * this.Panzoom.content.x;
        const d = i - u, p = i + u, m = Math.abs(f - i), b = Math.abs(f - d), E = Math.abs(f - p);
        E < m && E <= b ? (i = p, s += r) : b < m && b < E && (i = d, s -= r);
      }
    } else
      t = s = Math.max(0, Math.min(s, r - 1)), i = this.pages.length ? this.pages[t].left : 0;
    return this.page = t, this.pageIndex = s, o !== null && t !== o && (this.prevPage = o, this.prevPageIndex = a, this.trigger("change", t, o)), i;
  }
  destroy() {
...
let U = null;
const st = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden])", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])'], B = (n) => {
  if (n && X) {
...
}, ie = { minSlideCount: 2, minScreenHeight: 500, autoStart: !0, key: "t", Carousel: {}, tpl: `<div class="fancybox__thumb" style="background-image:url('{{src}}')"></div>` };
class rt {
  constructor(t) {
...
rt.defaults = ie;
const ot = (n, t) => {
  const e = new URL(n), i = new URLSearchParams(e.search);
  ...
  let o = n.match(/#t=((.*)?\d+s)/);
  return o && (s += `#t=${o[1]}`), s;
}, lt = { video: { autoplay: !0, ratio: 16 / 9 }, youtube: { autohide: 1, fs: 1, rel: 0, hd: 1, wmode: "transparent", enablejsapi: 1, html5: 1 }, vimeo: { hd: 1, show_title: 1, show_byline: 1, show_portrait: 0, fullscreen: 1 }, html5video: { tpl: `<video class="fancybox__html5video" playsinline controls controlsList="nodownload" poster="{{poster}}">
...
class ct {
  ...
  processType(t) {
    ...
    const e = t.src || "";
    let i = t.type || this.fancybox.options.type, s = null;
    if (!e || typeof e == "string") {
      if (s = e.match(/(?:youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i)) {
        const o = ot(e, this.fancybox.option("Html.youtube")), a = encodeURIComponent(s[1]);
        t.videoId = a, t.src = `https://www.youtube-nocookie.com/embed/${a}?${o}`, t.thumb = t.thumb || `https://i.ytimg.com/vi/${a}/mqdefault.jpg`, t.vendor = "youtube", i = "video";
      } else if (s = e.match(/^.+vimeo.com\/(?:\/)?([\d]+)(.*)?/)) {
        const o = ot(e, this.fancybox.option("Html.vimeo")), a = encodeURIComponent(s[1]);
        t.videoId = a, t.src = `https://player.vimeo.com/video/${a}?${o}`, t.vendor = "vimeo", i = "video";
      } else
        (s = e.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:(?:(?:maps\/(?:place\/(?:.*)\/)?\@(.*),(\d+.?\d+?)z))|(?:\?ll=))(.*)?/i)) ? (t.src = `//maps.google.${s[1]}/?ll=${(s[2] ? s[2] + "&z=" + Math.floor(s[3]) + (s[4] ? s[4].replace(/^\//, "&") : "") : s[4] + "").replace(/\?/, "&")}&output=${s[4] && s[4].indexOf("layer=c") > 0 ? "svembed" : "embed"}`, i = "map") : (s = e.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i)) && (t.src = `//maps.google.${s[1]}/maps?q=${s[2].replace("query=", "q=").replace("api=1", "")}&output=embed`, i = "map");
      i || (e.charAt(0) === "#" ? i = "inline" : (s = e.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (i = "html5video", t.format = t.format || "video/" + (s[1] === "ogv" ? "ogg" : s[1])) : e.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? i = "image" : e.match(/\.(pdf)((\?|#).*)?$/i) && (i = "pdf")), t.type = i || this.fancybox.option("defaultType", "image"), i !== "html5video" && i !== "video" || (t.video = x({}, this.fancybox.option("Html.video"), t.video), t._width && t._height ? t.ratio = parseFloat(t._width) / parseFloat(t._height) : t.ratio = t.ratio || t.video.ratio || lt.video.ratio);
    }
  }
  onReady() {
  ...
  loadInlineContent(t) {
    ...
    if (t.src instanceof HTMLElement)
      ...
      const i = t.src.split("#", 2), s = i.length === 2 && i[0] === "" ? i[1] : i[0];
  ...
  loadIframeContent(t) {
    ...
    s.style.visibility = "hidden", this.fancybox.setContent(t, s), s.appendChild(i), i.onerror = () => {
      ...
      e.hideLoading(t);
      let o = !1;
      i.isReady || (i.isReady = !0, o = !0), i.src.length && (i.parentNode.style.visibility = "", this.resizeIframe(t), o && e.revealContent(t));
  ...
  setAspectRatio(t) {
    ...
    if (i || s && o) {
      ...
      Math.abs(s / o - i) > 0.01 && (i < s / o ? s = o * i : o = s / i), Object.assign(e.style, { width: `${s}px`, height: `${o}px` });
    }
  }
  resizeIframe(t) {
    const e = t.$iframe;
    ...
    i && s && (t.autoSize = !1);
    const o = e.parentNode, a = o && o.style;
    if (t.preload !== !1 && t.autoSize !== !1 && a)
      try {
        const r = window.getComputedStyle(o), l = parseFloat(r.paddingLeft) + parseFloat(r.paddingRight), h = parseFloat(r.paddingTop) + parseFloat(r.paddingBottom), c = e.contentWindow.document, u = c.getElementsByTagName("html")[0], f = c.body;
        a.width = "", f.style.overflow = "hidden", i = i || u.scrollWidth + l, a.width = `${i}px`, f.style.overflow = "", a.flex = "0 0 auto", a.height = `${f.scrollHeight}px`, s = u.scrollHeight + h;
      } catch {
      }
    if (i || s) {
  ...
  onUnselectSlide(t, e, i) {
    ...
    let s = !1;
    i.vendor == "vimeo" ? s = { method: "pause", value: "true" } : i.vendor === "youtube" && (s = { event: "command", func: "pauseVideo" }), s && i.$iframe && i.$iframe.contentWindow && i.$iframe.contentWindow.postMessage(JSON.stringify(s), "*"), clearTimeout(i.poller);
  }
  onRemoveSlide(t, e, i) {
    i.xhr && (i.xhr.abort(), i.xhr = null), i.$iframe && (i.$iframe.onload = i.$iframe.onerror = null, i.$iframe.src = "//about:blank", i.$iframe = null);
    const s = i.$content;
    i.type === "inline" && s && (s.classList.remove("fancybox__content"), s.style.display !== "none" && (s.style.display = "none")), i.$closeButton && (i.$closeButton.remove(), i.$closeButton = null);
...
class ht {
  ...
  setContent(t) {
    ...
    if (s) {
      ...
      o.classList.add(typeof s == "string" ? s : "fancybox__image-wrap"), o.appendChild(i), e.appendChild(o), t.$wrap = o;
    } else
      e.appendChild(i);
  ...
  initSlidePanzoom(t) {
    t.Panzoom || (t.Panzoom = new I(t.$el, x(!0, this.fancybox.option("Image.Panzoom", {}), { viewport: t.$wrap, content: t.$image, width: t._width, height: t._height, wrapInner: !1, textSelection: !0, touch: this.fancybox.option("Image.touch"), panOnlyZoomed: !0, click: !1, wheel: !1 })), t.Panzoom.on("startAnimation", () => {
  ...
  getZoomInfo(t) {
    const e = t.$thumb.getBoundingClientRect(), i = e.width, s = e.height, o = t.$content.getBoundingClientRect(), a = o.width, r = o.height, l = o.top - e.top, h = o.left - e.left;
    let c = this.fancybox.option("Image.zoomOpacity");
    return c === "auto" && (c = Math.abs(i / s - a / r) > 0.1), { top: l, left: h, scale: a && i ? i / a : 1, opacity: c };
  }
  canZoom(t) {
    ...
    if (window.visualViewport && window.visualViewport.scale !== 1 || t.Panzoom && !t.Panzoom.content.width || !e.option("Image.zoom") || e.option("Image.fit") !== "contain")
      return !1;
    const s = t.$thumb;
    if (!s || t.state === "loading")
      return !1;
    i.classList.add("fancybox__no-click");
    const o = s.getBoundingClientRect();
    let a;
    if (this.fancybox.option("Image.ignoreCoveredThumbnail")) {
      const r = document.elementFromPoint(o.left + 1, o.top + 1) === s, l = document.elementFromPoint(o.right - 1, o.bottom - 1) === s;
      a = r && l;
    } else
      a = document.elementFromPoint(o.left + 0.5 * o.width, o.top + 0.5 * o.height) === s;
    return i.classList.remove("fancybox__no-click"), a;
  }
  zoomIn() {
    const t = this.fancybox, e = t.getSlide(), i = e.Panzoom, { top: s, left: o, scale: a, opacity: r } = this.getZoomInfo(e);
    t.trigger("reveal", e), i.panTo({ x: -1 * o, y: -1 * s, scale: a, friction: 0, ignoreBounds: !0 }), e.$content.style.visibility = "", e.state = "zoomIn", r === !0 && i.on("afterTransform", (l) => {
  ...
  zoomOut() {
    ...
    const o = (a) => {
      ...
      a || c || (s *= 0.82), i.panTo({ x: -1 * l, y: -1 * r, scale: h, friction: s, ignoreBounds: !0 }), s *= 0.98;
    };
  ...
  handleCursor(t) {
    if (t.type !== "image" || !t.$el)
      return;
    const e = t.Panzoom, i = this.fancybox.option("Image.click", !1, t), s = this.fancybox.option("Image.touch"), o = t.$el.classList, a = this.fancybox.option("Image.canZoomInClass"), r = this.fancybox.option("Image.canZoomOutClass");
    o.remove(r), o.remove(a), e && i === "toggleZoom" ? e && e.content.scale === 1 && e.option("maxScale") - e.content.scale > 0.01 ? o.add(a) : e.content.scale > 1 && !s && o.add(r) : i === "close" && o.add(r);
  }
  onWheel(t, e) {
  ...
  onClick(t, e) {
    ...
    }, o = this.fancybox.option("Image.click"), a = this.fancybox.option("Image.doubleClick");
  ...
  onPageChange(t, e) {
    const i = t.getSlide();
    e.slides.forEach((s) => {
      s.Panzoom && s.state === "done" && s.index !== i.index && s.Panzoom.panTo({ x: 0, y: 0, scale: 1, friction: 0.8 });
    });
  }
  attach() {
    this.fancybox.on(this.events);
...
ht.defaults = { canZoomInClass: "can-zoom_in", canZoomOutClass: "can-zoom_out", zoom: !0, zoomOpacity: "auto", zoomFriction: 0.82, ignoreCoveredThumbnail: !1, touch: !0, click: "toggleZoom", doubleClick: null, wheel: "zoom", fit: "contain", wrap: !1, Panzoom: { ratio: 1 } };
class C {
  constructor(t) {
    this.fancybox = t;
  ...
  onChange(t) {
    ...
    const i = e.prevPage === null, s = t.getSlide(), o = new URL(document.URL).hash;
    let a = !1;
    if (s.slug)
      a = "#" + s.slug;
    else {
      const r = s.$trigger && s.$trigger.dataset, l = t.option("slug") || r && r.fancybox;
      l && l.length && l !== "true" && (a = "#" + l + (e.slides.length > 1 ? "-" + (s.index + 1) : ""));
    }
    i && (this.origHash = o !== a ? o : ""), a && o !== a && (this.timer = setTimeout(() => {
      try {
  ...
  static startFromUrl() {
    ...
    a.length && (s === null && a.length === 1 ? o = a[0] : s && (o = a[s - 1]), o && o.dispatchEvent(new CustomEvent("click", { bubbles: !0, cancelable: !0 })));
  }
  static onHashChange() {
    const { slug: t, index: e } = C.getParsedURL(), i = C.Fancybox, s = i && i.getInstance();
    if (s && s.plugins.Hash) {
      if (t) {
        const o = s.Carousel;
        if (t === s.option("slug"))
          return o.slideTo(e - 1);
        for (let l of o.slides)
          if (l.slug && l.slug === t)
            return o.slideTo(l.index);
        const a = s.getSlide(), r = a.$trigger && a.$trigger.dataset;
        if (r && r.fancybox === t)
          return o.slideTo(e - 1);
      }
  ...
  static create(t) {
    ...
    C.Fancybox = t, X && window.requestAnimationFrame(() => {
...
const P = { pageXOffset: 0, pageYOffset: 0, element: () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement, activate(n) {
  P.pageXOffset = window.pageXOffset, P.pageYOffset = window.pageYOffset, n.requestFullscreen ? n.requestFullscreen() : n.mozRequestFullScreen ? n.mozRequestFullScreen() : n.webkitRequestFullscreen ? n.webkitRequestFullscreen() : n.msRequestFullscreen && n.msRequestFullscreen();
}, deactivate() {
...
} }, zoom: { type: "button", class: "fancybox__button--zoom", label: "TOGGLE_ZOOM", html: '<svg viewBox="0 0 24 24"><circle cx="10" cy="10" r="7"></circle><path d="M16 16 L21 21"></svg>', click: function(n) {
  n.preventDefault();
  const t = this.fancybox.getSlide().Panzoom;
  t && t.toggleZoom();
} }, download: { type: "link", label: "DOWNLOAD", class: "fancybox__button--download", html: '<svg viewBox="0 0 24 24"><path d="M12 15V3m0 12l-4-4m4 4l4-4M2 17l.62 2.48A2 2 0 004.56 21h14.88a2 2 0 001.94-1.51L22 17"/></svg>', click: function(n) {
  n.stopPropagation();
} }, thumbs: { type: "button", label: "TOGGLE_THUMBS", class: "fancybox__button--thumbs", html: '<svg viewBox="0 0 24 24"><circle cx="4" cy="4" r="1" /><circle cx="12" cy="4" r="1" transform="rotate(90 12 4)"/><circle cx="20" cy="4" r="1" transform="rotate(90 20 4)"/><circle cx="4" cy="12" r="1" transform="rotate(90 4 12)"/><circle cx="12" cy="12" r="1" transform="rotate(90 12 12)"/><circle cx="20" cy="12" r="1" transform="rotate(90 20 12)"/><circle cx="4" cy="20" r="1" transform="rotate(90 4 20)"/><circle cx="12" cy="20" r="1" transform="rotate(90 12 20)"/><circle cx="20" cy="20" r="1" transform="rotate(90 20 20)"/></svg>', click: function(n) {
  n.stopPropagation();
...
class dt {
  ...
  onPrepare() {
    ...
    if (this.state === "init" && (this.build(), this.update(), this.Slideshow = new se(t), !t.Carousel.prevPage && (t.option("slideshow.autoStart") && this.Slideshow.activate(), t.option("fullscreen.autoStart") && !P.element())))
      try {
  ...
  createElement(t) {
    ...
    for (const s in t.attr)
      e.setAttribute(s, t.attr[s]);
  ...
  build() {
    ...
    for (const o of this.fancybox.option("Toolbar.display")) {
      let a, r;
      if (O(o) ? (a = o.id, r = x({}, t[a], o)) : (a = o, r = t[a]), ["counter", "next", "prev", "slideshow"].includes(a) && this.fancybox.items.length < 2)
        continue;
      if (a === "fullscreen") {
    ...
    for (const o of e)
      if (o.items.length) {
        ...
        a.classList.add("fancybox__toolbar__items"), a.classList.add(`fancybox__toolbar__items--${o.position}`);
  ...
  update() {
    const t = this.fancybox.getSlide(), e = t.index, i = this.fancybox.items.length, s = t.downloadSrc || (t.type !== "image" || t.error ? null : t.src);
    ...
    const o = t.Panzoom, a = o && o.option("maxScale") > o.option("baseScale");
...
const ne = { ScrollLock: class {
  ...
  onReady() {
    ...
    n && (this.viewport = n, this.startY = 0, n.addEventListener("resize", this.onResize), this.updateViewport()), window.addEventListener("touchstart", this.onTouchstart, { passive: !1 }), window.addEventListener("touchmove", this.onTouchmove, { passive: !1 }), window.addEventListener("wheel", this.onWheel, { passive: !1 });
  }
  onResize() {
    this.updateViewport();
  }
  updateViewport() {
    const n = this.fancybox, t = this.viewport, e = t.scale || 1, i = n.$container;
    if (!i)
      return;
    let s = "", o = "", a = "";
    e - 1 > 0.1 && (s = t.width * e + "px", o = t.height * e + "px", a = `translate3d(${t.offsetLeft}px, ${t.offsetTop}px, 0) scale(${1 / e})`), i.style.width = s, i.style.height = o, i.style.transform = a;
  }
  onTouchstart(n) {
  ...
  onTouchmove(n) {
    ...
    if (!n.cancelable || n.touches.length > 1 || e !== 1)
      return;
    const i = W(n.composedPath()[0]);
    if (!i)
      return void n.preventDefault();
    const s = window.getComputedStyle(i), o = parseInt(s.getPropertyValue("height"), 10), a = n.touches ? n.touches[0].screenY : n.screenY, r = t <= a && i.scrollTop === 0, l = t >= a && i.scrollHeight - i.scrollTop === o;
  ...
  cleanup() {
    ...
    n && (n.removeEventListener("resize", this.onResize), this.viewport = null), window.removeEventListener("touchstart", this.onTouchstart, !1), window.removeEventListener("touchmove", this.onTouchmove, !1), window.removeEventListener("wheel", this.onWheel, { passive: !1 });
  }
  attach() {
...
}, Thumbs: rt, Html: ct, Toolbar: dt, Image: ht, Hash: C }, ut = { startIndex: 0, preload: 1, infinite: !0, showClass: "fancybox-zoomInUp", hideClass: "fancybox-fadeOut", animated: !0, hideScrollbar: !0, parentEl: null, mainClass: null, autoFocus: !0, trapFocus: !0, placeFocusBack: !0, click: "close", closeButton: "inside", dragToClose: !0, keyboard: { Escape: "close", Delete: "close", Backspace: "close", PageUp: "next", PageDown: "prev", ArrowUp: "next", ArrowDown: "prev", ArrowRight: "next", ArrowLeft: "prev" }, template: { closeButton: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" tabindex="-1"><path d="M20 20L4 4m16 0L4 20"/></svg>', spinner: '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="25 25 50 50" tabindex="-1"><circle cx="50" cy="50" r="20"/></svg>', main: null }, l10n: { CLOSE: "Close", NEXT: "Next", PREV: "Previous", MODAL: "You can close this modal content with the ESC key", ERROR: "Something Went Wrong, Please Try Again Later", IMAGE_ERROR: "Image Not Found", ELEMENT_NOT_FOUND: "HTML Element Not Found", AJAX_NOT_FOUND: "Error Loading AJAX : Not Found", AJAX_FORBIDDEN: "Error Loading AJAX : Forbidden", IFRAME_ERROR: "Error Loading Page", TOGGLE_ZOOM: "Toggle zoom level", TOGGLE_THUMBS: "Toggle thumbnails", TOGGLE_SLIDESHOW: "Toggle slideshow", TOGGLE_FULLSCREEN: "Toggle full-screen mode", DOWNLOAD: "Download" } }, N = /* @__PURE__ */ new Map();
let ae = 0;
class g extends j {
  constructor(t, e = {}) {
    t = t.map((i) => (i.width && (i._width = i.width), i.height && (i._height = i.height), i)), super(x(!0, {}, ut, e)), this.bindHandlers(), this.state = "init", this.setItems(t), this.attachPlugins(g.Plugins), this.trigger("init"), this.option("hideScrollbar") === !0 && this.hideScrollbar(), this.initLayout(), this.initCarousel(), this.attachEvents(), N.set(this.id, this), this.trigger("prepare"), this.state = "ready", this.trigger("ready"), this.$container.setAttribute("aria-hidden", "false"), this.option("trapFocus") && this.focus();
  }
  option(t, ...e) {
    const i = this.getSlide();
    let s = i ? i[t] : void 0;
    return s !== void 0 ? (typeof s == "function" && (s = s.call(this, this, ...e)), s) : super.option(t, ...e);
  }
  bindHandlers() {
  ...
  initLayout() {
    ...
    t && (this.$root.insertAdjacentHTML("beforeend", this.localize(t)), this.$container = this.$root.querySelector(".fancybox__container")), this.$container || (this.$container = document.createElement("div"), this.$root.appendChild(this.$container)), this.$container.onscroll = () => (this.$container.scrollLeft = 0, !1), Object.entries({ class: "fancybox__container", role: "dialog", tabIndex: "-1", "aria-modal": "true", "aria-hidden": "true", "aria-label": this.localize("{{MODAL}}") }).forEach((i) => this.$container.setAttribute(...i)), this.option("animated") && this.$container.classList.add("is-animated"), this.$backdrop = this.$container.querySelector(".fancybox__backdrop"), this.$backdrop || (this.$backdrop = document.createElement("div"), this.$backdrop.classList.add("fancybox__backdrop"), this.$container.appendChild(this.$backdrop)), this.$carousel = this.$container.querySelector(".fancybox__carousel"), this.$carousel || (this.$carousel = document.createElement("div"), this.$carousel.classList.add("fancybox__carousel"), this.$container.appendChild(this.$carousel)), this.$container.Fancybox = this, this.id = this.$container.getAttribute("id"), this.id || (this.id = this.options.id || ++ae, this.$container.setAttribute("id", "fancybox-" + this.id));
  ...
  onCreateSlide(t, e) {
    ...
    if (typeof this.options.caption == "function" && (i = this.options.caption.call(this, this, this.Carousel, e)), typeof i == "string" && i.length) {
      const s = document.createElement("div"), o = `fancybox__caption_${this.id}_${e.index}`;
      s.className = "fancybox__caption", s.innerHTML = i, s.setAttribute("id", o), e.$caption = e.$el.appendChild(s), e.$el.classList.add("has-caption"), e.$el.setAttribute("aria-labelledby", o);
    }
  }
  onSettle() {
  ...
  onKeydown(t) {
    ...
    if (!i || t.ctrlKey || t.altKey || t.shiftKey)
      return;
    const s = t.composedPath()[0], o = document.activeElement && document.activeElement.classList, a = o && o.contains("carousel__button");
    if (e !== "Escape" && !a && (t.target.isContentEditable || ["BUTTON", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(s.nodeName) !== -1) || this.trigger("keydown", e, t) === !1)
      return;
    const r = i[e];
  ...
  focus(t) {
    if (g.ignoreFocusChange || ["init", "closing", "customClosing", "destroy"].indexOf(this.state) > -1)
      return;
    const e = this.$container, i = this.getSlide(), s = i.state === "done" ? i.$el : null;
    ...
    let a, r = [];
    for (let l of o) {
      const h = l.offsetParent, c = s && s.contains(l), u = !this.Carousel.$viewport.contains(l);
    ...
    t ? r.indexOf(t.target) > -1 ? this.lastFocus = t.target : this.lastFocus === e ? B(r[r.length - 1]) : B(e) : this.option("autoFocus") && a ? B(a) : r.indexOf(document.activeElement) < 0 && B(e), this.lastFocus = document.activeElement, g.ignoreFocusChange = !1;
  }
  hideScrollbar() {
    if (!X)
      return;
  ...
  setContent(t, e, i = {}) {
    ...
    if (e instanceof HTMLElement)
      ["img", "iframe", "video", "audio"].indexOf(e.nodeName.toLowerCase()) > -1 ? (s = document.createElement("div"), s.appendChild(e)) : s = e;
    else {
  ...
  destroy() {
    ...
    this.Carousel.destroy(), this.detachPlugins(), this.Carousel = null, this.options = {}, this.events = {}, this.$container.remove(), this.$container = this.$backdrop = this.$carousel = null, t && B(t), N.delete(this.id);
  ...
  static fromEvent(t, e = {}) {
    ...
    let s, o, a, r = i;
    if ((r.matches("[data-fancybox-trigger]") || (r = r.closest("[data-fancybox-trigger]"))) && (e.triggerTarget = r, s = r && r.dataset && r.dataset.fancyboxTrigger), s) {
      const h = document.querySelectorAll(`[data-fancybox="${s}"]`), c = parseInt(r.dataset.fancyboxIndex, 10) || 0;
      r = h.length ? h[c] : r;
    }
  ...
  static fromOpener(t, e = {}) {
    let i = [], s = e.startIndex || 0, o = e.target || null;
    const a = (e = x({}, e, g.openers.get(t))).groupAll !== void 0 && e.groupAll, r = e.groupAttr === void 0 ? "data-fancybox" : e.groupAttr, l = r && o ? o.getAttribute(`${r}`) : "";
    if (!o || l || a) {
    ...
    if (o && !a && (i = l ? i.filter((c) => c.getAttribute(`${r}`) === l) : [o]), !i.length)
      return !1;
    const h = g.getInstance();
    return !(h && i.indexOf(h.options.$trigger) > -1) && (s = o ? i.indexOf(o) : s, i = i.map(function(c) {
      const u = ["false", "0", "no", "null", "undefined"], f = ["true", "1", "yes"], d = Object.assign({}, c.dataset), p = {};
  ...
  static getInstance(t) {
    return t ? N.get(t) : Array.from(N.values()).reverse().find((e) => !e.isClosing() && e) || null;
  }
  static close(t = !0, e) {
    if (t)
...
g.version = "4.0.31", g.defaults = ut, g.openers = /* @__PURE__ */ new Map(), g.Plugins = ne, g.bind("[data-fancybox]");
for (const [n, t] of Object.entries(g.Plugins || {}))
...
const D = {
  ...
  activate(n) {
    D.pageXOffset = window.pageXOffset, D.pageYOffset = window.pageYOffset, n.requestFullscreen ? n.requestFullscreen() : n.mozRequestFullScreen ? n.mozRequestFullScreen() : n.webkitRequestFullscreen ? n.webkitRequestFullscreen() : n.msRequestFullscreen && n.msRequestFullscreen();
  },
  deactivate() {
    document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen && document.webkitExitFullscreen();
  }
  ...
  role: "presentation"
}, ce = { class: "BaseButton -primary -icon-only pointer-events-none" }, he = { class: "icon" };
...
const ue = /* @__PURE__ */ _(re, [["render", de]]), Y = {
  ...
  computed: {
    ...
    computedCaption() {
      let n = this.caption && this.caption.length ? this.$options.filters.truncate(this.caption, 180) : "";
      ...
      Toolbar: {
        items: {
          ...
          fullscreen: {
            ...
            click(n) {
              n.preventDefault(), D.element() ? D.deactivate() : D.activate(this.fancybox.$container);
            }
          },
          slideshow: {
            type: "button",
...
}), pe = ["href", "data-fancybox", "data-src", "data-width", "data-height", "data-srcset", "data-sizes", "data-theme", "data-caption", "data-title", "data-animated", "data-download-src", "data-url", "data-max-width"];
