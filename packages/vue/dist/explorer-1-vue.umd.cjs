;(function (x, c) {
  typeof exports == 'object' && typeof module < 'u'
    ? c(exports, require('vue'))
    : typeof define == 'function' && define.amd
      ? define(['exports', 'vue'], c)
      : ((x = typeof globalThis < 'u' ? globalThis : x || self), c((x.Explorer1Vue = {}), x.Vue))
})(this, function (x, c) {
  'use strict'
  const H = { primary: '-primary', secondary: '-secondary', dark: '-dark', social: '-social' },
    ct = c.defineComponent({
      name: 'BaseButton',
      props: {
        variant: {
          type: String,
          required: !1,
          default: 'primary',
          validator: (n) => Object.keys(H).includes(n)
        },
        compact: { type: Boolean, default: !1, required: !1 },
        blockClasses: { type: String, required: !1, default: 'inline-block' },
        disabled: { type: Boolean, default: !1, required: !1 },
        ariaLabel: { type: String, default: '', required: !1 },
        to: { type: [String, Object], required: !1, default: null },
        href: { type: String, required: !1, default: null }
      },
      emits: ['click'],
      computed: {
        tag() {
  ...
  function dt(n, t, e, i, s, o) {
    return (
      c.openBlock(),
      c.createBlock(
        c.resolveDynamicComponent(n.tag),
        {
          class: c.normalizeClass(['BaseButton text-contrast-none', n.variantClass]),
        ...
        {
          default: c.withCtx(() => [
            c.createElementVNode('span', ht, [
              c.renderSlot(n.$slots, 'default'),
              c.renderSlot(n.$slots, 'icon')
            ])
          ]),
          _: 3
        },
  ...
  const q = S(ct, [['render', dt]]),
    ut = c.defineComponent({ name: 'IconCaret' }),
    ft = {
      class: 'IconCaret',
      width: '8',
      height: '14',
  ...
  function mt(n, t, e, i, s, o) {
    return c.openBlock(), c.createElementBlock('svg', ft, pt)
  }
  const W = S(ut, [['render', mt]]),
    gt = c.defineComponent({
      name: 'MixinAnimationCaret',
      components: { IconCaret: W },
      props: {
        passedWrapperClass: { type: String || null, required: !1, default: '' },
        arrowClass: { type: String, required: !1, default: '' },
        color: { type: String, required: !1, default: 'text-theme-red' },
        marginLeft: { type: String, default: 'ml-1', required: !1 },
        inline: { type: Boolean, default: !1, required: !1 }
      },
      computed: {
        computedClass() {
          let n = ''
    ...
    bt = { class: 'arrow' },
    yt = { class: 'arrow-fixed' }
  function vt(n, t, e, i, s, o) {
    const a = c.resolveComponent('IconCaret')
    return (
      c.openBlock(),
      c.createElementBlock(
        'span',
        { class: c.normalizeClass(['MixinAnimationCaret', n.computedClass]) },
        [
          c.createElementVNode('span', null, [c.renderSlot(n.$slots, 'default')]),
          c.createElementVNode(
            'span',
            {
              class: c.normalizeClass(['arrow-wrapper', [n.arrowClass, n.color, n.marginLeft]]),
              'aria-hidden': 'true'
            },
            [
              c.createElementVNode('span', bt, [c.createVNode(a)]),
              c.createElementVNode('span', yt, [c.createVNode(a)])
            ],
            2
          )
        ],
  ...
  const V = S(gt, [['render', vt]]),
    ...
    xt = c.defineComponent({
      name: 'BaseLink',
      components: { MixinAnimationCaret: V },
      props: {
        variant: {
          type: String,
          required: !1,
          default: 'default',
          validator: (n) => Object.keys(X).includes(n)
        },
        ...
        target: { type: String, required: !1, default: void 0 },
        externalTargetBlank: { type: Boolean, required: !1, default: !1 },
        caret: { type: Boolean, required: !1, default: !1 },
        caretWrapperClass: { type: String, default: '' },
        caretClass: { type: String, default: '' },
        caretInline: { type: Boolean, required: !1, default: !1 },
        caretColor: { type: String, required: !1, default: '' },
        caretMarginLeft: { type: String, required: !1, default: '' }
      },
      emits: ['linkClicked', 'specificLinkClicked'],
      computed: {
        computedClass() {
          let n = X[this.variant]
          return (
  ...
  function $t(n, t, e, i, s, o) {
    const a = c.resolveComponent('MixinAnimationCaret'),
      r = c.resolveComponent('nuxt-link')
    return (
      c.openBlock(),
      c.createElementBlock('div', null, [
        n.to
          ? (c.openBlock(),
            c.createBlock(
              r,
              {
                key: 0,
                class: c.normalizeClass(['group', n.computedClass]),
                to: n.to,
                target: n.theTarget,
                rel: n.theRel,
                'aria-label': n.ariaLabel,
                ...
                default: c.withCtx(() => [
                  n.caretInline && n.caret
                    ? (c.openBlock(),
                      c.createBlock(
                        a,
                        {
                          key: 0,
                          inline: '',
                          class: c.normalizeClass(n.caretWrapperClass),
                          'arrow-class': n.caretClass,
                          color: n.caretColor,
                          'margin-left': n.caretMarginLeft
                        },
                        { default: c.withCtx(() => [c.renderSlot(n.$slots, 'default')]), _: 3 },
                        8,
                    ...
                    : n.variant === 'primary' || n.caret
                      ...
                      : c.renderSlot(n.$slots, 'default', { key: 2 })
                ]),
                _: 3
              },
              8,
  ...
  const Ct = S(xt, [['render', $t]]),
    St = c.defineComponent({ name: 'IconArrows' }),
    Et = {
      class: 'IconArrows',
      width: '32',
      height: '12',
  ...
  function Lt(n, t, e, i, s, o) {
    return c.openBlock(), c.createElementBlock('svg', Et, kt)
  }
  const U = S(St, [['render', Lt]]),
    Pt = c.defineComponent({ name: 'IconLocation' }),
    Tt = {
      class: 'IconLocation',
      width: '16',
      height: '22',
    ...
    _t = [
      c.createElementVNode(
        ...
        [
          ...
          c.createElementVNode('circle', { cx: '12', cy: '9', r: '3' })
        ],
        -1
      )
    ]
  function zt(n, t, e, i, s, o) {
    return c.openBlock(), c.createElementBlock('svg', Tt, _t)
  }
  const Mt = S(Pt, [['render', zt]]),
    At = c.defineComponent({ name: 'IconArrows' }),
    Ot = {
      class: 'IconUser',
      width: '21',
      height: '21',
  ...
  function Ft(n, t, e, i, s, o) {
    return c.openBlock(), c.createElementBlock('svg', Ot, It)
  }
  const Bt = S(At, [['render', Ft]]),
    L = (n) =>
      typeof n == 'object' &&
      n !== null &&
      ...
      for (let o = 0; o < s; o++) {
        ...
        for (let r in a)
          if (a.hasOwnProperty(r)) {
            const l = a[r]
            if (t && (Array.isArray(l) || L(l))) {
              const d = Array.isArray(l) ? [] : {}
              e[r] = w(!0, e.hasOwnProperty(r) ? e[r] : d, l)
            } else e[r] = l
          }
      }
      return e
    },
    v = (n, t = 1e4) => ((n = parseFloat(n) || 0), Math.round((n + Number.EPSILON) * t) / t),
    O = function (n) {
      return (
  ...
  class Dt {
    constructor(t, { start: e = () => !0, move: i = () => {}, end: s = () => {} } = {}) {
      ;(this._element = t),
        ...
        (this._touchStart = (o) => {
          for (const a of Array.from(o.changedTouches || [])) this._triggerPointerStart(new P(a), o)
        }),
        (this._move = (o) => {
          const a = this.currentPointers.slice(),
            r = ((l) => 'changedTouches' in l)(o)
              ? Array.from(o.changedTouches).map((l) => new P(l))
              : [new P(o)]
          for (const l of r) {
            const d = this.currentPointers.findIndex((h) => h.id === l.id)
            d < 0 || (this.currentPointers[d] = l)
          }
  ...
  class N {
    constructor(t = {}) {
      ;(this.options = w(!0, {}, t)), (this.plugins = []), (this.events = {})
    ...
    attachPlugins(t) {
      ...
      for (const [i, s] of Object.entries(t || {}))
        this.options[i] === !1 ||
          this.plugins[i] ||
          ((this.options[i] = w({}, s.defaults || {}, this.options[i])), (e[i] = new s(this)))
  ...
  class T extends N {
    constructor(t, e = {}) {
      super(w(!0, {}, Rt, e)), (this.state = 'init'), (this.$container = t)
    ...
    attachEvents() {
      ...
      const t = new Dt(this.$container, {
              ...
              (this.option('textSelection') &&
                ((o, a, r) => {
                  ...
                  for (let h = 0; h < l.length; h++) {
                    ...
                    if (a >= p.left && r >= p.top && a <= p.right && r <= p.bottom) return f
                  }
                  return !1
        ...
        move: (e, i, s) => {
          ...
          ;(this.dragOffset.x += r),
            (this.dragOffset.y += l),
            (this.dragOffset.scale *= f),
            (this.dragOffset.time = Date.now() - this.dragPosition.time)
          const p = this.dragStart.scale === 1 && this.option('lockAxis')
          if (p && !this.lockAxis) {
            if (Math.abs(this.dragOffset.x) < 6 && Math.abs(this.dragOffset.y) < 6)
              return void s.preventDefault()
            const u = Math.abs((180 * Math.atan2(this.dragOffset.y, this.dragOffset.x)) / Math.PI)
            this.lockAxis = u > 45 && u < 135 ? 'y' : 'x'
          }
          if (p === 'xy' || this.lockAxis !== 'y') {
            if (
              ...
              const u = B(t.startPointers[0], t.startPointers[1]),
                m = u.clientX - this.dragStart.rect.x,
                b = u.clientY - this.dragStart.rect.y,
                { deltaX: y, deltaY: k } = this.getZoomDelta(
                  this.content.scale * this.dragOffset.scale,
                  m,
                  b
                )
              ;(this.dragPosition.x -= y),
                (this.dragPosition.y -= k),
    ...
    updateMetrics(t) {
      ...
      let l = this.option('width'),
        ...
        h =
          ...
          ((f = i),
          Math.max(
            parseFloat(f.naturalWidth || 0),
            parseFloat((f.width && f.width.baseVal && f.width.baseVal.value) || 0),
            parseFloat(f.offsetWidth || 0),
            parseFloat(f.scrollWidth || 0)
          ))
      var f
      let p =
        d ||
        ((C) =>
          Math.max(
            ...
            parseFloat((C.height && C.height.baseVal && C.height.baseVal.value) || 0),
      ...
      ;(h = v(h * u)), (p = v(p * u)), (l = h), (d = p)
      const m = i.getBoundingClientRect(),
        b = s.getBoundingClientRect(),
        y = s == e ? b : e.getBoundingClientRect()
      let k = Math.max(s.offsetWidth, v(b.width)),
        nt = Math.max(s.offsetHeight, v(b.height)),
        F = window.getComputedStyle(s)
      if (
        ((k -= parseFloat(F.paddingLeft) + parseFloat(F.paddingRight)),
        (nt -= parseFloat(F.paddingTop) + parseFloat(F.paddingBottom)),
        (this.viewport.width = k),
        (this.viewport.height = nt),
        a)
      ) {
        if (Math.abs(h - m.width) > 0.1 || Math.abs(p - m.height) > 0.1) {
          const C = ((at, rt, oe, ne) => {
            const lt = Math.min(oe / at || 0, ne / rt)
            return { width: at * lt || 0, height: rt * lt || 0 }
          })(h, p, Math.min(h, m.width), Math.min(p, m.height))
          ;(l = v(C.width)), (d = v(C.height))
        }
        Object.assign(i.style, { width: `${l}px`, height: `${d}px`, transform: '' })
      }
      if (
        (r &&
          (Object.assign(s.style, { width: `${l}px`, height: `${d}px` }),
          (this.viewport = { ...this.viewport, width: l, height: d })),
        o && a && typeof this.options.maxScale != 'function')
      ) {
        const C = this.option('maxScale')
      ...
      ;(this.content = {
        ...
        (this.container = { width: y.width, height: y.height }),
    ...
    zoomTo(t = this.option('baseScale'), { x: e = null, y: i = null } = {}) {
      ...
      const s = v(this.content.scale / (this.content.width / this.content.fitWidth), 1e7)
    ...
    panTo({
      ...
      if (((i = i || this.content.scale || 1), !o)) {
        ...
        a && (t = Math.max(Math.min(t, a.to), a.from)),
    ...
    setEdgeForce() {
      ...
      if (
        ...
        const d = this.content.x + (this.velocity.x + l) / this.friction
        d >= e.from && d <= e.to && (l += this.velocity.x),
          (this.velocity.x = l),
          this.recalculateTransform()
      }
      if (a || r) {
        let l = ((a ? i.from : i.to) - this.content.y) * t
        const d = this.content.y + (l + this.velocity.y) / this.friction
        d >= i.from && d <= i.to && (l += this.velocity.y),
          (this.velocity.y = l),
          this.recalculateTransform()
      }
    }
    ...
    setTransform(t) {
      ...
      if (
        (t
          ? ((e = v(this.transform.x)),
            (i = v(this.transform.y)),
        ...
        let o, a
        ;(o = v(this.content.fitWidth * s)),
          (a = v(this.content.fitHeight * s)),
  ...
  class _ extends N {
    constructor(t, e = {}) {
      ...
      ;(this.slideNext = Y(this.slideNext.bind(this), 250)),
        (this.slidePrev = Y(this.slidePrev.bind(this), 250)),
        this.init(),
        (t.__Carousel = this)
    }
    init() {
    ...
    initSlides() {
      ;(this.slides = []),
        ...
        Array.isArray(this.options.slides) &&
          (this.slides = w(!0, [...this.slides], this.options.slides))
    }
    updateMetrics() {
      let t,
        e = 0,
        i = []
      this.slides.forEach((u, m) => {
        const b = u.$el,
          y = u.isDom || !t ? this.getSlideMetrics(b) : t
        ;(u.index = m), (u.width = y), (u.left = e), (t = y), (e += y), i.push(m)
      })
      let s = Math.max(this.$track.offsetWidth, v(this.$track.getBoundingClientRect().width)),
      ...
      if (Number.isInteger(r) && e > s)
        for (let u = 0; u < this.slides.length; u += r)
          a.push({ indexes: i.slice(u, u + r), slides: this.slides.slice(u, u + r) })
      else {
        let u = 0,
          m = 0
        for (let b = 0; b < this.slides.length; b += 1) {
          let y = this.slides[b]
          ;(!a.length || m + y.width > s) &&
            (a.push({ indexes: [], slides: [] }), (u = a.length - 1), (m = 0)),
            (m += y.width),
            a[u].indexes.push(b),
            a[u].slides.push(y)
        }
      ...
      a.forEach((u, m) => {
        ;(u.index = m),
          (u.width = u.slides.reduce((b, y) => b + y.width, 0)),
          (u.left = u.slides[0].left),
          l && (u.left += 0.5 * (s - u.width) * -1),
          d &&
            !this.option('infiniteX', this.option('infinite')) &&
            e > s &&
            ((u.left = Math.max(u.left, 0)), (u.left = Math.min(u.left, e - s)))
      })
      const h = []
      let f
      a.forEach((u) => {
        ...
        f && m.left === f.left
          ? ((f.width += m.width),
            (f.slides = [...f.slides, ...m.slides]),
            (f.indexes = [...f.indexes, ...m.indexes]))
          : ((m.index = h.length), (f = m), h.push(m))
      }),
        (this.pages = h)
      let p = this.page
      if (p === null) {
        ...
        ;(p =
          u !== null ? this.findPageForSlide(u) : parseInt(this.option('initialPage', 0), 10) || 0),
          h[p] || (p = h.length && p > h.length ? h[h.length - 1].index : 0),
          (this.page = p),
          (this.pageIndex = p)
      }
    ...
    getSlideMetrics(t) {
      ...
      let e = Math.max(t.offsetWidth, v(t.getBoundingClientRect().width))
    ...
    initPanzoom() {
      ...
      ;(this.Panzoom = new T(this.$container, t)),
        this.Panzoom.on({
    ...
    manageSlideVisiblity() {
      ...
      this.slides.forEach((h) => {
        let f,
          p,
          u = 0
        ;(f = i - a), (p = i + e + r), (f -= s * (e + a + r)), (p += s * (e + a + r))
        const m = h.left + h.width > f && h.left < p
        ;(f = i + t - a), (p = i + t + e + r), (f -= s * (e + a + r))
        const b = o && h.left + h.width > f && h.left < p
        ;(f = i - t - a), (p = i - t + e + r), (f -= s * (e + a + r))
        const y = o && h.left + h.width > f && h.left < p
        b || m || y
          ? (this.createSlideEl(h),
            m && (u = 0),
            b && (u = -1),
            y && (u = 1),
            h.left + h.width > i && h.left <= i + e + r && (u = 0))
          : this.removeSlideEl(h),
          (h.hasDiff = u)
      })
      let l = 0,
        d = 0
      this.slides.forEach((h, f) => {
        let p = 0
        h.$el
          ? (f !== l || h.hasDiff ? (p = d + h.hasDiff * t) : (d = 0),
            (h.$el.style.left = Math.abs(p) > 0.1 ? `${d + h.hasDiff * t}px` : ''),
            l++)
          : (d += h.width)
      }),
    ...
    setPage(t, e) {
      ...
      if (((t = ((s % r) + r) % r), this.option('infiniteX', this.option('infinite')) && l > d)) {
        const h = Math.floor(s / r) || 0,
          f = l
        if (((i = this.pages[t].left + h * f), e === !0 && r > 2)) {
          ...
          const u = i - f,
            ...
            y = Math.abs(p - u),
            k = Math.abs(p - m)
          k < b && k <= y ? ((i = m), (s += r)) : y < b && y < k && ((i = u), (s -= r))
        }
      } else
    ...
    z = (n) => {
      if (n && I) {
        ...
        try {
          ...
          else if (D) n.focus({ preventScroll: !0 })
          else {
    ...
    processType(t) {
      ...
      if (!e || typeof e == 'string') {
        if (
          ...
          const o = Q(e, this.fancybox.option('Html.youtube')),
          ...
          const o = Q(e, this.fancybox.option('Html.vimeo')),
            a = encodeURIComponent(s[1])
          ;(t.videoId = a),
        ...
        i ||
          ...
          (i !== 'html5video' && i !== 'video') ||
            ((t.video = w({}, this.fancybox.option('Html.video'), t.video)),
            t._width && t._height
              ? (t.ratio = parseFloat(t._width) / parseFloat(t._height))
              : (t.ratio = t.ratio || t.video.ratio || tt.video.ratio))
      }
    }
    onReady() {
      ...
      if (t.preload !== !1 && t.autoSize !== !1 && a)
        try {
          const r = window.getComputedStyle(o),
            ...
            f = h.getElementsByTagName('html')[0],
            p = h.body
          ;(a.width = ''),
  ...
  class it {
    ...
    initSlidePanzoom(t) {
      t.Panzoom ||
        ((t.Panzoom = new T(
          t.$el,
          w(!0, this.fancybox.option('Image.Panzoom', {}), {
            viewport: t.$wrap,
            content: t.$image,
            width: t._width,
            height: t._height,
    ...
    getZoomInfo(t) {
      ...
      return (
        h === 'auto' && (h = Math.abs(i / s - a / r) > 0.1),
        { top: l, left: d, scale: a && i ? i / a : 1, opacity: h }
      )
    }
    canZoom(t) {
      const e = this.fancybox,
    ...
    zoomOut() {
      ...
      const o = (a) => {
        const { top: r, left: l, scale: d, opacity: h } = this.getZoomInfo(e)
        a || h || (s *= 0.82),
          i.panTo({ x: -1 * l, y: -1 * r, scale: d, friction: s, ignoreBounds: !0 }),
          (s *= 0.98)
      }
  ...
  class $ {
    ...
    static startFromUrl() {
      ...
      const { hash: e, slug: i, index: s } = $.getParsedURL()
      if (!i) return
    ...
    static onHashChange() {
      const { slug: t, index: e } = $.getParsedURL(),
        i = $.Fancybox,
        s = i && i.getInstance()
      if (s && s.plugins.Hash) {
        if (t) {
    ...
    static create(t) {
      function e() {
        window.addEventListener('hashchange', $.onHashChange, !1), $.startFromUrl()
      }
      ;($.Fancybox = t),
        I &&
  ...
  const E = {
    ...
    activate(n) {
      ;(E.pageXOffset = window.pageXOffset),
  ...
  const Xt = {
    ...
    items: {
      ...
      fullscreen: {
        ...
        click: function (n) {
          n.preventDefault(), E.element() ? E.deactivate() : E.activate(this.fancybox.$container)
        }
      },
      slideshow: {
        type: 'button',
  ...
  class st {
    ...
    onPrepare() {
      ...
      if (
        ...
        (this.build(),
        this.update(),
        (this.Slideshow = new Vt(t)),
        !t.Carousel.prevPage &&
          (t.option('slideshow.autoStart') && this.Slideshow.activate(),
          t.option('fullscreen.autoStart') && !E.element()))
      )
        try {
    ...
    build() {
      ...
      for (const o of this.fancybox.option('Toolbar.display')) {
        let a, r
        if (
          (L(o) ? ((a = o.id), (r = w({}, t[a], o))) : ((a = o), (r = t[a])),
  ...
  const Ut = {
      ScrollLock: class {
        ...
        onWheel(n) {
          O(n.composedPath()[0]) || n.preventDefault()
        }
        cleanup() {
          this.pendingUpdate &&
  ...
  class g extends N {
    ...
    setItems(t) {
      ...
      for (const i of t) {
        ...
        !a &&
          o &&
          ((a = o.currentSrc || o.src),
          !a && o.dataset && (a = o.dataset.lazySrc || o.dataset.src)),
    ...
    focus(t) {
      ...
      const o = Array.from(e.querySelectorAll(K))
      let a,
        r = []
      for (let l of o) {
        const d = l.offsetParent,
          h = s && s.contains(l),
          f = !this.Carousel.$viewport.contains(l)
        d && (h || f)
          ? (r.push(l),
            ...
            (l.hasAttribute('autoFocus') ||
              (!a && h && !l.classList.contains('carousel__button'))) &&
              (a = l))
      ...
      t
        ...
        : this.option('autoFocus') && a
          ? z(a)
          : r.indexOf(document.activeElement) < 0 && z(e),
    ...
    static fromEvent(t, e = {}) {
      ...
      if (
        ...
        const d = document.querySelectorAll(`[data-fancybox="${s}"]`),
          h = parseInt(r.dataset.fancyboxIndex, 10) || 0
        r = d.length ? d[h] : r
      }
        ...
        .some((d) => {
          ...
          try {
            a instanceof Element &&
              ...
              (h = a.matches(d) || (a = a.closest(d)))
          } catch {}
          return !!h && (t.preventDefault(), (o = d), !0)
        })
      let l = !1
      if (o) {
        ;(e.event = t), (e.target = a), (a.origTarget = i), (l = g.fromOpener(o, e))
        const d = g.getInstance()
        d && d.state === 'ready' && t.detail && document.body.classList.add('is-using-mouse')
      }
      return l
    }
    static fromOpener(t, e = {}) {
      let i = [],
        s = e.startIndex || 0,
        o = e.target || null
      const a = (e = w({}, e, g.openers.get(t))).groupAll !== void 0 && e.groupAll,
        r = e.groupAttr === void 0 ? 'data-fancybox' : e.groupAttr,
        l = r && o ? o.getAttribute(`${r}`) : ''
      if (!o || l || a) {
        const h = e.root || (o ? o.getRootNode() : document.body)
        i = [].slice.call(h.querySelectorAll(t))
      }
      if ((o && !a && (i = l ? i.filter((h) => h.getAttribute(`${r}`) === l) : [o]), !i.length))
        return !1
      const d = g.getInstance()
      return (
        !(d && i.indexOf(d.options.$trigger) > -1) &&
        ((s = o ? i.indexOf(o) : s),
        (i = i.map(function (h) {
          const f = ['false', '0', 'no', 'null', 'undefined'],
            p = ['true', '1', 'yes'],
            u = Object.assign({}, h.dataset),
            m = {}
          for (let [b, y] of Object.entries(u))
            if (b !== 'fancybox')
              if (b === 'width' || b === 'height') m[`_${b}`] = y
              else if (typeof y == 'string' || y instanceof String)
                if (f.indexOf(y) > -1) m[b] = !1
                else if (p.indexOf(m[b]) > -1) m[b] = !0
                else
                  try {
                    m[b] = JSON.parse(y)
                  } catch {
        ...
        new g(i, w({}, e, { startIndex: s, $trigger: o })))
      )
    }
    static bind(t, e = {}) {
      function i() {
    ...
    static destroy() {
      ...
      ;(g.openers = new Map()), document.body.removeEventListener('click', g.fromEvent, !1)
    }
    ...
    static close(t = !0, e) {
      if (t) for (const i of M.values()) i.close(e)
      else {
  ...
  const A = {
    ...
    Yt = c.defineComponent({ name: 'MixinFancyboxOpenButton', components: { IconExpand: U } }),
    Zt = { ref: 'FancyboxOpenButton', class: 'MixinFancyboxOpenButton', role: 'presentation' },
    Gt = { class: 'BaseButton -primary -icon-only pointer-events-none' },
    Kt = { class: 'icon' }
  function Jt(n, t, e, i, s, o) {
    const a = c.resolveComponent('IconExpand')
    return (
      c.openBlock(),
      c.createElementBlock(
        'div',
        Zt,
        [c.createElementVNode('div', Gt, [c.createElementVNode('span', Kt, [c.createVNode(a)])])],
        512
      )
    )
  }
  const Qt = S(Yt, [['render', Jt]]),
    R = {
    ...
    te = c.defineComponent({
      name: 'MixinFancybox',
      components: { MixinFancyboxOpenButton: Qt },
      filters: {
        truncate(n) {
      ...
      props: {
        infinite: { type: Boolean, required: !1, default: !0 },
        showThumbnails: { type: Boolean, required: !1, default: !1 },
        animated: { type: Boolean, required: !1, default: !1 },
        galleryName: { type: String, required: !1, default: null },
        src: { type: String, required: !1 },
        srcSet: { type: String, required: !1 },
        sizes: { type: String, required: !1 },
        downloadSrc: { type: String, required: !1 },
        caption: { type: String, required: !1 },
        credit: { type: String, required: !1 },
        title: { type: String, required: !1 },
        detailUrl: { type: String, required: !1 },
      ...
      mounted() {
        return g.bind('[data-fancybox]', {
          ...
          mainClass: this.computedClass ? this.computedClass : R.dark,
          ...
          Image: { zoom: this.animated },
          Thumbs: { autoStart: this.showThumbnails },
          Toolbar: {
            items: {
              counter: {
                type: 'div',
              ...
              fullscreen: {
                ...
                click(n) {
                  n.preventDefault(),
                    A.element() ? A.deactivate() : A.activate(this.fancybox.$container)
                }
              },
              slideshow: {
                type: 'button',
  ...
  function ie(n, t, e, i, s, o) {
    const a = c.resolveComponent('MixinFancyboxOpenButton')
    return (
      c.openBlock(),
      c.createElementBlock(
        'a',
        ...
        [c.createVNode(a), c.renderSlot(n.$slots, 'default')],
        8,
        ee
      )
    )
  }
  const se = S(te, [['render', ie]])
  ;(x.BaseButton = q),
    (x.BaseHeading = q),
    (x.BaseLink = Ct),
    (x.IconArrows = U),
