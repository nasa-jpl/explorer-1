...
const MissionDetailHeroTemplate = (args) => ({
  ...
  template: `<MissionDetailHero
    ...
    :hero-fallback="heroImage"
  />`
})

const MissionDetailHeroInstrumentOnlyTemplate = (args) => ({
  props: Object.keys(args),
  components: { MissionDetailHero },
  template: `<MissionDetailHero
    :title="title"
...
const MissionDetailHeroHeroFallbackTemplate = (args) => ({
  props: Object.keys(args),
  components: { MissionDetailHero },
  template: `<MissionDetailHero
    :title="title"
...
// stories
export const CubeRrt = MissionDetailHeroTemplate.bind({})
CubeRrt.args = {
  templateStyle: 'light',
  title: 'CubeRRT',
...
export const Ecostress = MissionDetailHeroTemplate.bind({})
Ecostress.args = {
  templateStyle: 'light',
  title: 'ECOSTRESS',
...
export const Jason3 = MissionDetailHeroTemplate.bind({})
Jason3.args = {
  templateStyle: 'light',
  title: 'Jason-3',
  subtitle: null,
...
export const Oco2 = MissionDetailHeroTemplate.bind({})
Oco2.args = {
  templateStyle: 'light',
  title: 'OCO-2',
...
export const NoBackground = MissionDetailHeroInstrumentOnlyTemplate.bind({})
NoBackground.args = {
  templateStyle: 'light',
  title: 'GRACE-FO',
  subtitle: 'The Gravity Recovery and Climate Experiment Follow-On',
...
export const StaticHero = MissionDetailHeroHeroFallbackTemplate.bind({})
StaticHero.args = {
  templateStyle: 'light',
  title: 'ECOSTRESS',
  subtitle: 'ECOsystem Spaceborne Thermal Radiometer Experiment on Space Station',
