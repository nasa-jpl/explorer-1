<template>
  <div
    v-if="data"
    class="NavDesktopDropdownContent bg-jpl-blue-darker bg-opacity-98 edu:bg-gradient-to-r edu:from-black edu:to-primary edu:to-90% edu:bg-black 3xl:px-0 px-4 py-10 text-white"
  >
    <div
