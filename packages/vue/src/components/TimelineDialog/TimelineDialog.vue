<template>
  ...
  >
    <div class="p-3 sm:p-10">
      ...
      />
      <div tabindex="0" class="dialog-main py-3 overflow-auto relative">
        <h2
          :id="`${data.id}-heading`"
        ...
        <BlockText variant="medium" :text="data.description" />
      </div>
      <div class="my-3">
        <BaseLink
          v-if="data.milestoneLink"
          variant="default"
          :to="data.milestoneLink.page ? data.milestoneLink.page.url : null"
...
import { Milestone } from './../PageTimeline/BlockMilestone.vue'
