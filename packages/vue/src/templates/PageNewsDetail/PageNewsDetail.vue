  ...
  >
    ...
    <HeroMedia
      v-if="
        !heroEmpty &&
        !heroInline &&
        (data.hero[0].blockType === 'HeroImageBlock' ||
          data.hero[0].blockType === 'VideoBlock')
      "
    ...
    <LayoutHelper indent="col-2" class="mb-10">
      <DetailHeadline
        :title="data.title"
    ...
    >
      <BlockText
        ...
        :text="data.topper"
      />
      <p class="text-body-lg font-semibold" itemprop="abstract">
        {{ data.summary }}
      </p>
    </LayoutHelper>

    <!-- streamfield blocks -->
    <BlockStreamfield itemprop="articleBody" :data="data.body" />
    ...
    <LayoutHelper
      v-if="
        (data.mediaContacts && data.mediaContacts.length > 0) ||
        data.releaseNumber
      "
      indent="col-3"
      class="lg:my-18 my-10"
    >
      ...
      <p v-if="data.releaseNumber" class="text-body-sm text-gray-mid-dark">
        {{ data.releaseNumber }}
      </p>
    </LayoutHelper>
    ...
    <div
      v-if="
        data.relatedPagesForMoreSection &&
        data.relatedPagesForMoreSection.length
      "
