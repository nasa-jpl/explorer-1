...
export default {
  title: 'WWW/Layouts/PageCuratedGallery',
...
// template
const PageCuratedGalleryTemplate = (args) => ({
  props: Object.keys(args),
  components: { PageCuratedGallery },
  template: `<PageCuratedGallery :data="data"/>`
})

// stories
export const CuratedGallery = PageCuratedGalleryTemplate.bind({})
CuratedGallery.storyName = 'PageCuratedGallery'
CuratedGallery.args = {
  data: {
    galleryItems: [
      {
