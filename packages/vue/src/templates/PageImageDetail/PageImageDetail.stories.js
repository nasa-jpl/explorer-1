...
export default {
  title: 'WWW/Layouts/PageImageDetail',
...
// template
const PageImageDetailTemplate = (args) => ({
  props: Object.keys(args),
  components: { PageImageDetail },
  template: `<PageImageDetail :data="data"/>`
})
...
// stories
export const ImageDetail = PageImageDetailTemplate.bind({})
ImageDetail.args = { ...ImageDetailPageData }

// stories
export const NoTabbedCarousels = PageImageDetailTemplate.bind({})
NoTabbedCarousels.args = {
  data: {
