...
export default {
  title: 'WWW/Layouts/PageTimeline',
...
const milestoneImages = () => {
  const planet = Object.values(planets)[Math.floor(Math.random() * Object.keys(planets).length)]
  return {
    thumbnailImage: {
      alt: '',
      src: {
        height: '122',
        width: '122',
        url: `https://source.unsplash.com/${planet}/122x122`
      }
    },
    image: {
      alt: '',
      ...
      credit: '',
      detailUrl: null,
      original: `https://source.unsplash.com/${planet}/1024x768`,
      src: {
        height: '1024',
        width: '768',
        url: `https://source.unsplash.com/${planet}/1024x768`
      }
    },
    backgroundImage: {
      screenMd: {
        height: '480',
        width: '480',
        url: `https://source.unsplash.com/${planet}/480x480`
      },
      src: {
        height: '346',
        width: '346',
        url: `https://source.unsplash.com/${planet}/346x346`
      }
    }
  }
}
...
// template
const PageTimelineTemplate = (args) => ({
  props: Object.keys(args),
  components: { PageTimeline },
  template: `<PageTimeline :data="contentPage"/>`
})

// stories
export const Template = PageTimelineTemplate.bind({})
Template.storyName = 'PageTimeline' // single story hoisting
Template.args = {
  contentPage: PageTimelineData
}
