...
import { EventDetailHeroData } from '../EventDetailHero/EventDetailHero.stories'
import { EventsBlockLinkCarouselData } from '../BlockLinkCarousel/BlockLinkCarousel.stories'
import PageEventDetail from './PageEventDetail.vue'

export default {
  title: 'WWW/Layouts/PageEventDetail',
...
// template
const PageEventDetailTemplate = (args) => ({
  props: Object.keys(args),
  components: { PageEventDetail },
  template: `<PageEventDetail :data="event" />`
})

// stories
export const EventDetail = PageEventDetailTemplate.bind({})
EventDetail.args = {
  event: {
    id: '285',
