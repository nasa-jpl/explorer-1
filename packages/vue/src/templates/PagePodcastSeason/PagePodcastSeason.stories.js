import { HeroMediumData } from '../HeroMedium/HeroMedium.stories'
...
export default {
  title: 'WWW/Layouts/PagePodcastSeason',
...
// template
const PagePodcastSeasonTemplate = (args) => ({
  props: Object.keys(args),
  components: { PagePodcastSeason },
  template: `<PagePodcastSeason :data="podcast"/>`
})

// stories
export const Template = PagePodcastSeasonTemplate.bind({})
Template.storyName = 'PagePodcastSeason'
Template.args = {
  podcast: PagePodcastSeasonData
}
