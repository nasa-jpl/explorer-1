...
<Canvas className="sbdocs-preview-full-width" of={Stories.BaseWidth} />
...
<Canvas className="sbdocs-preview-full-width" of={Stories.ColTwoStart} />
...
<Canvas className="sbdocs-preview-full-width" of={Stories.ColThreeStart} />
...
<Canvas className="sbdocs-preview-full-width" of={Stories.ColFourStart} />
