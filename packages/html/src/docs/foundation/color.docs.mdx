...
| <div class="bg-jpl-blue-light p-4"></div>  | JPL Aqua       | `aqua`            | `#489FDF` |
| <div class="bg-blue p-4"></div>            | Blue           | `blue`            | `#8BCBFA` |
| <div class="bg-jpl-blue-darker p-4"></div> | Dark Blue      | `jpl-blue-darker` | `#004562` |
...
| Color                                    | Name              | Token           | Value     |
| :--------------------------------------- | :---------------- | :-------------- | :-------- |
| <div class="bg-jpl-teal p-4"></div>      | JPL Sky Blue      | `jpl-teal`      | `#53C8ED` |
| <div class="bg-jpl-teal-dark p-4"></div> | JPL Sky Blue Dark | `jpl-teal-dark` | `#0080A4` |
...
| Color                                    | Name                | Token           | Value     |
| :--------------------------------------- | :------------------ | :-------------- | :-------- |
| <div class="bg-warning p-4"></div>       | Alert Gold          | `alert`         | `#FFBA32` |
| <div class="bg-warning-light p-4"></div> | Alert Gold Light    | `alert-light`   | `#FFF9EB` |
| <div class="bg-disabled p-4"></div>      | Disabled Gray       | `disabled`      | `#D8D8D8` |
| <div class="bg-error p-4"></div>         | Error Red           | `error`         | `#C1152E` |
| <div class="bg-error-light p-4"></div>   | Error Red Light     | `error-light`   | `#FFE8EB` |
| <div class="bg-focus p-4"></div>         | Focus Blue          | `focus`         | `#1871C9` |
| <div class="bg-focus-light p-4"></div>   | Focus Blue Light    | `focus-light`   | `#E8F1FA` |
| <div class="bg-success p-4"></div>       | Success Green       | `success`       | `#33A17B` |
| <div class="bg-success-light p-4"></div> | Success Green Light | `success-light` | `#E1F5EE` |
