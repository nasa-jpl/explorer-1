  ...
  components={[
    {
      ...
      path: '/story/components-blocks-heroes-small--base-story',
      fullWidth: true,
      fullCanvas: true
    },
    {
    ...
    },
    {
      ...
      path: '/story/components-blocks-heroes-large--base-story',
      fullWidth: true,
      fullCanvas: true
    },
    {
      ...
      path: '/story/components-blocks-heroes-media-only--base-story',
      fullWidth: true,
      fullCanvas: true,
