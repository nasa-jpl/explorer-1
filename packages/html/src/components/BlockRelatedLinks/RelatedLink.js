  ...
  let icon =
    variant == 'document'
      ? IconDownloadTemplate({
          customClass: 'text-action xl:mx-4 flex-none ml-4 text-2xl leading-normal text-3xl'
        })
      : variant == 'internal'
        ? IconArrowTemplate({
            customClass: 'text-action xl:mx-4 flex-none ml-4 text-2xl leading-normal text-3xl'
        ...
        : IconExternalTemplate({
            customClass: 'text-action xl:mx-4 flex-none ml-4 text-2xl leading-normal text-lg'
          })
