...
export const AppBarInternalTemplate = ({
  ...
  const signInTemplate = includeSignIn
    ? signedIn && userData
      ...
      `
      : `
      <a href="${logInUrl}" class="flex flex-nowrap items-center focus:outline-none focus:ring-2 mr-2 py-1 font-text tracking-[-.03rem] font-medium">
        <span class="hidden lg:block mr-2">
          Sign In
        </span>
        <span class="block shrink-0">
  ...
  <div class="AppBarInternal sticky lg:relative top-0 z-30">
    <div class="bg-red-600 text-white font-medium relative z-10">
